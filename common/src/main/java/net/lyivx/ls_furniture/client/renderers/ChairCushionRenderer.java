...
public class ChairCushionRenderer implements BlockEntityRenderer<ChairBlockEntity> {

    private final BlockRenderDispatcher blockRenderer;

    public ChairCushionRenderer(BlockEntityRendererProvider.Context context) {
        this.blockRenderer = context.getBlockRenderDispatcher();
    }

    @Override
    public void render(@NotNull ChairBlockEntity blockEntity, float partialTicks, @NotNull PoseStack stack, @NotNull MultiBufferSource source, int light, int overlay) {
