...
public class ModRecipes {
    ...
    public static final Supplier<CodecRecipeSerializer<ChoppingBoardRecipe>> CHOPPING_BOARD_SERIALIZER = SERIALIZERS.register("chopping_board", () -> new CodecRecipeSerializer<>(CHOPPING_BOARD_RECIPE.get(), ChoppingBoardRecipe::codec));
    ...
    public static final Supplier<CodecRecipeSerializer<WorldInteractionRecipe>> WORLD_INTERACTION_RECIPE_SERIALIZER = SERIALIZERS.register("world_interaction", () -> new CodecRecipeSerializer<>(WORLD_INTERACTION_RECIPE.get(), WorldInteractionRecipe::codec));

    public static final Supplier<RecipeType<WorkstationRecipe>> WORKSTATION_RECIPE = RegHelper.registerRecipeType(
            res("workstation"));
    public static final Supplier<RecipeSerializer<WorkstationRecipe>> WORKSTATION_RECIPE_SERIALIZER = RegHelper.registerRecipeSerializer(
            res("workstation"), WorkstationRecipe.Serializer::new);
}