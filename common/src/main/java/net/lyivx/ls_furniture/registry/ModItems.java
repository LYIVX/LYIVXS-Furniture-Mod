...
public class ModItems {
    ...
    public static final Supplier<Item> WORKSTATION = DECO.register("workstation",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("workstation")))));
    ...
    public static final Supplier<Item> CHOPPING_BOARD = DECO.register("chopping_board",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("chopping_board")))));
    ...
    public static final Supplier<Item> CUTTING_BOARD = DECO.register("cutting_board",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cutting_board")))));

    public static final Supplier<Item> PLATE = DECO.register("plate",
            () -> new BlockItem(ModBlocks.PLATE.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("plate")))));

    public static final Supplier<Item> TOASTER = DECO.register("toaster",
            () -> new BlockItem(ModBlocks.TOASTER.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("toaster")))));

    public static final Supplier<Item> KETTLE = DECO.register("kettle",
            () -> new BlockItem(ModBlocks.KETTLE.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("kettle")))));
    ...
    public static final Supplier<Item> MICROWAVE = DECO.register("microwave",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("microwave")))));
    ...
    public static final Supplier<Item> FRIDGE_FREEZER = DECO.register("fridge_freezer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("fridge_freezer")))));

    public static final Supplier<Item> DRAINER = DECO.register("drainer",
            () -> new BlockItem(ModBlocks.DRAINER.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("drainer")))));
    ...
    public static final Supplier<OvenVentItem> OVEN_VENT = DECO.register("oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oven_vent")))));
    ...
    public static final Supplier<Item> OVEN_VENT_SHAFT = DECO.register("oven_vent_shaft",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oven_vent_shaft")))));
    ...
    public static final Supplier<Item> FIRE_PLACE = DECO.register("fire_place",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("fire_place")))));
    ...
    public static final Supplier<Item> FIRE_PLACE_CHIMNEY_SHAFT = DECO.register("fire_place_chimney_shaft",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("fire_place_chimney_shaft")))));

    public static final Supplier<Item> TV = DECO.register("tv",
            () -> new BlockItem(ModBlocks.TV.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("tv")))));
    ...
    public static final Supplier<Item> COMPUTER = DECO.register("computer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("computer")))));
    ...
    public static final Supplier<SinkModuleItem> SINK_MODULE = INGREDIENTS.register("sink_module",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("sink_module")))));
    ...
    public static final Supplier<OvenModuleItem> OVEN_MODULE = INGREDIENTS.register("oven_module",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oven_module")))));
    ...
    public static final Supplier<Item> WRENCH = TOOLS.register("wrench",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("wrench")))));

    public static final Supplier<Item> CHISEL = TOOLS.register("chisel",
            () -> new ChiselItem(new Item.Properties().durability(1000)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("chisel")))));

    public static final Supplier<Item> SAW = TOOLS.register("saw",
            () -> new SawItem(new Item.Properties().durability(1000)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("saw")))));

    public static final Supplier<Item> SHEARS = TOOLS.register("shears",
            () -> new ShearsItem(new Item.Properties().durability(1000)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("shears")))));

    public static final Supplier<Item> HAMMER = TOOLS.register("hammer",
            () -> new HammerItem(new Item.Properties().durability(1000)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("hammer")))));

    public static final Supplier<Item> KNIFE = TOOLS.register("knife",
            () -> new KnifeItem(new Item.Properties().durability(1000)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("knife")))));

    public static final Supplier<LetterItem> LETTER = DECO.register("letter",
            () -> new LetterItem(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("letter")))));

    public static final Supplier<Item> SLICED_BREAD = FOODS.register("sliced_bread",
            () -> new Item(new Item.Properties()
            .food(ModFoodProperties.SLICED_BREAD)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("sliced_bread")))));

    public static final Supplier<Item> TOAST = FOODS.register("toast",
            () -> new Item(new Item.Properties()
            .food(ModFoodProperties.TOAST)
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("toast")))));

    public static final Supplier<Item> OAK_BARK = INGREDIENTS_BURNABLE_100.register("oak_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_bark")))));

    public static final Supplier<Item> SPRUCE_BARK = INGREDIENTS_BURNABLE_100.register("spruce_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_bark")))));

    public static final Supplier<Item> BIRCH_BARK = INGREDIENTS_BURNABLE_100.register("birch_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_bark")))));

    public static final Supplier<Item> JUNGLE_BARK = INGREDIENTS_BURNABLE_100.register("jungle_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_bark")))));

    public static final Supplier<Item> ACACIA_BARK = INGREDIENTS_BURNABLE_100.register("acacia_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_bark")))));

    public static final Supplier<Item> DARK_OAK_BARK = INGREDIENTS_BURNABLE_100.register("dark_oak_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_bark")))));

    public static final Supplier<Item> MANGROVE_BARK = INGREDIENTS_BURNABLE_100.register("mangrove_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_bark")))));

    public static final Supplier<Item> CHERRY_BARK = INGREDIENTS_BURNABLE_100.register("cherry_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_bark")))));

    public static final Supplier<Item> BAMBOO_BARK = INGREDIENTS_BURNABLE_100.register("bamboo_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_bark")))));

    public static final Supplier<Item> CRIMSON_BARK = INGREDIENTS_BURNABLE_100.register("crimson_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_bark")))));

    public static final Supplier<Item> WARPED_BARK = INGREDIENTS_BURNABLE_100.register("warped_bark",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_bark")))));

    ///////////////////////////////// STICKS / RODS ////////////////////////////////////
    
    public static final Supplier<Item> IRON_ROD = INGREDIENTS.register("iron_rod",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("iron_rod")))));
    
    public static final Supplier<Item> OAK_STICK = INGREDIENTS_BURNABLE_100.register("oak_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_stick")))));

    public static final Supplier<Item> SPRUCE_STICK = INGREDIENTS_BURNABLE_100.register("spruce_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_stick")))));

    public static final Supplier<Item> BIRCH_STICK = INGREDIENTS_BURNABLE_100.register("birch_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_stick")))));

    public static final Supplier<Item> JUNGLE_STICK = INGREDIENTS_BURNABLE_100.register("jungle_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_stick")))));

    public static final Supplier<Item> ACACIA_STICK = INGREDIENTS_BURNABLE_100.register("acacia_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_stick")))));

    public static final Supplier<Item> DARK_OAK_STICK = INGREDIENTS_BURNABLE_100.register("dark_oak_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_stick")))));

    public static final Supplier<Item> MANGROVE_STICK = INGREDIENTS_BURNABLE_100.register("mangrove_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_stick")))));

    public static final Supplier<Item> CHERRY_STICK = INGREDIENTS_BURNABLE_100.register("cherry_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_stick")))));

    public static final Supplier<Item> BAMBOO_STICK = INGREDIENTS_BURNABLE_100.register("bamboo_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_stick")))));

    public static final Supplier<Item> CRIMSON_STICK = INGREDIENTS_BURNABLE_100.register("crimson_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_stick")))));

    public static final Supplier<Item> WARPED_STICK = INGREDIENTS_BURNABLE_100.register("warped_stick",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_stick")))));
    ...
    public static final Supplier<Item> ELECTRICAL_FURNITURE_PACK = INGREDIENTS.register("electrical_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("electrical_furniture_pack")))));

    public static final Supplier<Item> CONSTRUCTION_FURNITURE_PACK = INGREDIENTS.register("construction_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("construction_furniture_pack")))));

    public static final Supplier<Item> OAK_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("oak_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_furniture_pack")))));

    public static final Supplier<Item> SPRUCE_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("spruce_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_furniture_pack")))));

    public static final Supplier<Item> BIRCH_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("birch_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_furniture_pack")))));

    public static final Supplier<Item> JUNGLE_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("jungle_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_furniture_pack")))));

    public static final Supplier<Item> ACACIA_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("acacia_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_furniture_pack")))));

    public static final Supplier<Item> DARK_OAK_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("dark_oak_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_furniture_pack")))));

    public static final Supplier<Item> MANGROVE_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("mangrove_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_furniture_pack")))));

    public static final Supplier<Item> CHERRY_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("cherry_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_furniture_pack")))));

    public static final Supplier<Item> BAMBOO_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("bamboo_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_furniture_pack")))));

    public static final Supplier<Item> CRIMSON_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("crimson_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_furniture_pack")))));

    public static final Supplier<Item> WARPED_FURNITURE_PACK = INGREDIENTS_BURNABLE_200.register("warped_furniture_pack",
            () -> new Item(new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_furniture_pack")))));
    ...
    public static final Supplier<Item> OAK_CHEST = DECO.register("oak_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_chest")))));
    ...
    public static final Supplier<Item> SPRUCE_CHEST = DECO.register("spruce_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_chest")))));
    ...
    public static final Supplier<Item> BIRCH_CHEST = DECO.register("birch_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_chest")))));
    ...
    public static final Supplier<Item> JUNGLE_CHEST = DECO.register("jungle_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_chest")))));
    ...
    public static final Supplier<Item> ACACIA_CHEST = DECO.register("acacia_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_chest")))));
    ...
    public static final Supplier<Item> DARK_OAK_CHEST = DECO.register("dark_oak_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_chest")))));
    ...
    public static final Supplier<Item> MANGROVE_CHEST = DECO.register("mangrove_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_chest")))));
    ...
    public static final Supplier<Item> CHERRY_CHEST = DECO.register("cherry_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_chest")))));
    ...
    public static final Supplier<Item> BAMBOO_CHEST = DECO.register("bamboo_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_chest")))));
    ...
    public static final Supplier<Item> CRIMSON_CHEST = DECO.register("crimson_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_chest")))));
    ...
    public static final Supplier<Item> WARPED_CHEST = DECO.register("warped_chest",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_chest")))));
    ...
    public static final Supplier<Item> OAK_BARREL = DECO.register("oak_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_barrel")))));
    ...
    public static final Supplier<Item> SPRUCE_BARREL = DECO.register("spruce_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_barrel")))));
    ...
    public static final Supplier<Item> BIRCH_BARREL = DECO.register("birch_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_barrel")))));
    ...
    public static final Supplier<Item> JUNGLE_BARREL = DECO.register("jungle_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_barrel")))));
    ...
    public static final Supplier<Item> ACACIA_BARREL = DECO.register("acacia_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_barrel")))));
    ...
    public static final Supplier<Item> DARK_OAK_BARREL = DECO.register("dark_oak_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_barrel")))));
    ...
    public static final Supplier<Item> MANGROVE_BARREL = DECO.register("mangrove_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_barrel")))));
    ...
    public static final Supplier<Item> CHERRY_BARREL = DECO.register("cherry_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_barrel")))));
    ...
    public static final Supplier<Item> BAMBOO_BARREL = DECO.register("bamboo_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_barrel")))));
    ...
    public static final Supplier<Item> CRIMSON_BARREL = DECO.register("crimson_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_barrel")))));
    ...
    public static final Supplier<Item> WARPED_BARREL = DECO.register("warped_barrel",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_barrel")))));
    ...
    public static final Supplier<Item> OAK_CRATE = DECO.register("oak_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_crate")))));
    ...
    public static final Supplier<Item> SPRUCE_CRATE = DECO.register("spruce_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_crate")))));
    ...
    public static final Supplier<Item> BIRCH_CRATE = DECO.register("birch_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_crate")))));
    ...
    public static final Supplier<Item> JUNGLE_CRATE = DECO.register("jungle_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_crate")))));
    ...
    public static final Supplier<Item> ACACIA_CRATE = DECO.register("acacia_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_crate")))));
    ...
    public static final Supplier<Item> DARK_OAK_CRATE = DECO.register("dark_oak_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_crate")))));
    ...
    public static final Supplier<Item> MANGROVE_CRATE = DECO.register("mangrove_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_crate")))));
    ...
    public static final Supplier<Item> CHERRY_CRATE = DECO.register("cherry_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_crate")))));
    ...
    public static final Supplier<Item> BAMBOO_CRATE = DECO.register("bamboo_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_crate")))));
    ...
    public static final Supplier<Item> CRIMSON_CRATE = DECO.register("crimson_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_crate")))));
    ...
    public static final Supplier<Item> WARPED_CRATE = DECO.register("warped_crate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_crate")))));
    ...
    */
    ...
    public static final Supplier<Item> OAK_SOFA = DECO.register("oak_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_sofa")))));
    ...
    public static final Supplier<Item> SPRUCE_SOFA = DECO.register("spruce_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_sofa")))));
    ...
    public static final Supplier<Item> BIRCH_SOFA = DECO.register("birch_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_sofa")))));
    ...
    public static final Supplier<Item> JUNGLE_SOFA = DECO.register("jungle_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_sofa")))));
    ...
    public static final Supplier<Item> ACACIA_SOFA = DECO.register("acacia_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_sofa")))));
    ...
    public static final Supplier<Item> DARK_OAK_SOFA = DECO.register("dark_oak_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_sofa")))));
    ...
    public static final Supplier<Item> MANGROVE_SOFA = DECO.register("mangrove_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_sofa")))));
    ...
    public static final Supplier<Item> CHERRY_SOFA = DECO.register("cherry_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_sofa")))));
    ...
    public static final Supplier<Item> BAMBOO_SOFA = DECO.register("bamboo_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_sofa")))));
    ...
    public static final Supplier<Item> CRIMSON_SOFA = DECO.register("crimson_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_sofa")))));
    ...
    public static final Supplier<Item> WARPED_SOFA = DECO.register("warped_sofa",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_sofa")))));

    ////////////////////////////////////// BEDS ////////////////////////////////////

    public static final Supplier<Item> OAK_BED = DECO.register("oak_bed",
            () -> new BlockItem(ModBlocks.OAK_BED.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_bed")))));
    ...
    public static final Supplier<Item> SPRUCE_BED = DECO.register("spruce_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_bed")))));
    ...
    public static final Supplier<Item> BIRCH_BED = DECO.register("birch_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_bed")))));
    ...
    public static final Supplier<Item> JUNGLE_BED = DECO.register("jungle_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_bed")))));
    ...
    public static final Supplier<Item> ACACIA_BED = DECO.register("acacia_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_bed")))));
    ...
    public static final Supplier<Item> DARK_OAK_BED = DECO.register("dark_oak_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_bed")))));
    ...
    public static final Supplier<Item> MANGROVE_BED = DECO.register("mangrove_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_bed")))));
    ...
    public static final Supplier<Item> CHERRY_BED = DECO.register("cherry_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_bed")))));
    ...
    public static final Supplier<Item> BAMBOO_BED = DECO.register("bamboo_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_bed")))));
    ...
    public static final Supplier<Item> CRIMSON_BED = DECO.register("crimson_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_bed")))));
    ...
    public static final Supplier<Item> WARPED_BED = DECO.register("warped_bed",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_bed")))));
    ...
    public static final Supplier<Item> OAK_CHAIR = DECO.register("oak_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_chair")))));
    ...
    public static final Supplier<Item> SPRUCE_CHAIR = DECO.register("spruce_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_chair")))));
    ...
    public static final Supplier<Item> BIRCH_CHAIR = DECO.register("birch_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_chair")))));
    ...
    public static final Supplier<Item> JUNGLE_CHAIR = DECO.register("jungle_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_chair")))));
    ...
    public static final Supplier<Item> ACACIA_CHAIR = DECO.register("acacia_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_chair")))));
    ...
    public static final Supplier<Item> DARK_OAK_CHAIR = DECO.register("dark_oak_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_chair")))));
    ...
    public static final Supplier<Item> MANGROVE_CHAIR = DECO.register("mangrove_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_chair")))));
    ...
    public static final Supplier<Item> CHERRY_CHAIR = DECO.register("cherry_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_chair")))));
    ...
    public static final Supplier<Item> BAMBOO_CHAIR = DECO.register("bamboo_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_chair")))));
    ...
    public static final Supplier<Item> CRIMSON_CHAIR = DECO.register("crimson_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_chair")))));
    ...
    public static final Supplier<Item> WARPED_CHAIR = DECO.register("warped_chair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_chair")))));
    ...
    public static final Supplier<Item> OAK_STOOL = DECO.register("oak_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_stool")))));
    ...
    public static final Supplier<Item> SPRUCE_STOOL = DECO.register("spruce_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_stool")))));
    ...
    public static final Supplier<Item> BIRCH_STOOL = DECO.register("birch_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_stool")))));
    ...
    public static final Supplier<Item> JUNGLE_STOOL = DECO.register("jungle_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_stool")))));
    ...
    public static final Supplier<Item> ACACIA_STOOL = DECO.register("acacia_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_stool")))));
    ...
    public static final Supplier<Item> DARK_OAK_STOOL = DECO.register("dark_oak_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_stool")))));
    ...
    public static final Supplier<Item> MANGROVE_STOOL = DECO.register("mangrove_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_stool")))));
    ...
    public static final Supplier<Item> CHERRY_STOOL = DECO.register("cherry_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_stool")))));
    ...
    public static final Supplier<Item> BAMBOO_STOOL = DECO.register("bamboo_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_stool")))));
    ...
    public static final Supplier<Item> CRIMSON_STOOL = DECO.register("crimson_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_stool")))));
    ...
    public static final Supplier<Item> WARPED_STOOL = DECO.register("warped_stool",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_stool")))));
    ...
    public static final Supplier<Item> OAK_TABLE = DECO.register("oak_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_table")))));
    ...
    public static final Supplier<Item> SPRUCE_TABLE = DECO.register("spruce_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_table")))));
    ...
    public static final Supplier<Item> BIRCH_TABLE = DECO.register("birch_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_table")))));
    ...
    public static final Supplier<Item> JUNGLE_TABLE = DECO.register("jungle_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_table")))));
    ...
    public static final Supplier<Item> ACACIA_TABLE = DECO.register("acacia_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_table")))));
    ...
    public static final Supplier<Item> DARK_OAK_TABLE = DECO.register("dark_oak_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_table")))));
    ...
    public static final Supplier<Item> MANGROVE_TABLE = DECO.register("mangrove_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_table")))));
    ...
    public static final Supplier<Item> CHERRY_TABLE = DECO.register("cherry_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_table")))));
    ...
    public static final Supplier<Item> BAMBOO_TABLE = DECO.register("bamboo_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_table")))));
    ...
    public static final Supplier<Item> CRIMSON_TABLE = DECO.register("crimson_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_table")))));
    ...
    public static final Supplier<Item> WARPED_TABLE = DECO.register("warped_table",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_table")))));
    ...
    public static final Supplier<Item> OAK_COUNTER = DECO.register("oak_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_counter")))));
    ...
    public static final Supplier<Item> OAK_COUNTER_ISLAND = DECO.register("oak_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_counter_island")))));
    ...
    public static final Supplier<Item> OAK_COUNTER_CUPBOARD = DECO.register("oak_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_counter_cupboard")))));
    ...
    public static final Supplier<Item> OAK_COUNTER_DRAWER = DECO.register("oak_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_counter_drawer")))));
    ...
    public static final Supplier<Item> OAK_COUNTER_OVEN = DECO.register("oak_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_counter_oven")))));
    ...
    public static final Supplier<Item> OAK_COUNTER_SINK = DECO.register("oak_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_counter_sink")))));
    ...
    public static final Supplier<Item> OAK_CABINET = DECO.register("oak_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_cabinet")))));
    ...
    public static final Supplier<Item> OAK_CABINET_CUPBOARD = DECO.register("oak_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> OAK_CABINET_OVEN_VENT = DECO.register("oak_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> SPRUCE_COUNTER = DECO.register("spruce_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_counter")))));
    ...
    public static final Supplier<Item> SPRUCE_COUNTER_ISLAND = DECO.register("spruce_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_counter_island")))));
    ...
    public static final Supplier<Item> SPRUCE_COUNTER_CUPBOARD = DECO.register("spruce_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_counter_cupboard")))));
    ...
    public static final Supplier<Item> SPRUCE_COUNTER_DRAWER = DECO.register("spruce_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_counter_drawer")))));
    ...
    public static final Supplier<Item> SPRUCE_COUNTER_OVEN = DECO.register("spruce_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_counter_oven")))));
    ...
    public static final Supplier<Item> SPRUCE_COUNTER_SINK = DECO.register("spruce_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_counter_sink")))));
    ...
    public static final Supplier<Item> SPRUCE_CABINET = DECO.register("spruce_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_cabinet")))));
    ...
    public static final Supplier<Item> SPRUCE_CABINET_CUPBOARD = DECO.register("spruce_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> SPRUCE_CABINET_OVEN_VENT = DECO.register("spruce_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> BIRCH_COUNTER = DECO.register("birch_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_counter")))));
    ...
    public static final Supplier<Item> BIRCH_COUNTER_ISLAND = DECO.register("birch_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_counter_island")))));
    ...
    public static final Supplier<Item> BIRCH_COUNTER_CUPBOARD = DECO.register("birch_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_counter_cupboard")))));
    ...
    public static final Supplier<Item> BIRCH_COUNTER_DRAWER = DECO.register("birch_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_counter_drawer")))));
    ...
    public static final Supplier<Item> BIRCH_COUNTER_OVEN = DECO.register("birch_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_counter_oven")))));
    ...
    public static final Supplier<Item> BIRCH_COUNTER_SINK = DECO.register("birch_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_counter_sink")))));
    ...
    public static final Supplier<Item> BIRCH_CABINET = DECO.register("birch_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_cabinet")))));
    ...
    public static final Supplier<Item> BIRCH_CABINET_CUPBOARD = DECO.register("birch_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> BIRCH_CABINET_OVEN_VENT = DECO.register("birch_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> JUNGLE_COUNTER = DECO.register("jungle_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_counter")))));
    ...
    public static final Supplier<Item> JUNGLE_COUNTER_ISLAND = DECO.register("jungle_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_counter_island")))));
    ...
    public static final Supplier<Item> JUNGLE_COUNTER_CUPBOARD = DECO.register("jungle_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_counter_cupboard")))));
    ...
    public static final Supplier<Item> JUNGLE_COUNTER_DRAWER = DECO.register("jungle_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_counter_drawer")))));
    ...
    public static final Supplier<Item> JUNGLE_COUNTER_OVEN = DECO.register("jungle_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_counter_oven")))));
    ...
    public static final Supplier<Item> JUNGLE_COUNTER_SINK = DECO.register("jungle_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_counter_sink")))));
    ...
    public static final Supplier<Item> JUNGLE_CABINET = DECO.register("jungle_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_cabinet")))));
    ...
    public static final Supplier<Item> JUNGLE_CABINET_CUPBOARD = DECO.register("jungle_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> JUNGLE_CABINET_OVEN_VENT = DECO.register("jungle_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> ACACIA_COUNTER = DECO.register("acacia_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_counter")))));
    ...
    public static final Supplier<Item> ACACIA_COUNTER_ISLAND = DECO.register("acacia_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_counter_island")))));
    ...
    public static final Supplier<Item> ACACIA_COUNTER_CUPBOARD = DECO.register("acacia_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_counter_cupboard")))));
    ...
    public static final Supplier<Item> ACACIA_COUNTER_DRAWER = DECO.register("acacia_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_counter_drawer")))));
    ...
    public static final Supplier<Item> ACACIA_COUNTER_OVEN = DECO.register("acacia_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_counter_oven")))));
    ...
    public static final Supplier<Item> ACACIA_COUNTER_SINK = DECO.register("acacia_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_counter_sink")))));
    ...
    public static final Supplier<Item> ACACIA_CABINET = DECO.register("acacia_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_cabinet")))));
    ...
    public static final Supplier<Item> ACACIA_CABINET_CUPBOARD = DECO.register("acacia_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> ACACIA_CABINET_OVEN_VENT = DECO.register("acacia_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> DARK_OAK_COUNTER = DECO.register("dark_oak_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_counter")))));
    ...
    public static final Supplier<Item> DARK_OAK_COUNTER_ISLAND = DECO.register("dark_oak_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_counter_island")))));
    ...
    public static final Supplier<Item> DARK_OAK_COUNTER_CUPBOARD = DECO.register("dark_oak_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_counter_cupboard")))));
    ...
    public static final Supplier<Item> DARK_OAK_COUNTER_DRAWER = DECO.register("dark_oak_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_counter_drawer")))));
    ...
    public static final Supplier<Item> DARK_OAK_COUNTER_OVEN = DECO.register("dark_oak_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_counter_oven")))));
    ...
    public static final Supplier<Item> DARK_OAK_COUNTER_SINK = DECO.register("dark_oak_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_counter_sink")))));
    ...
    public static final Supplier<Item> DARK_OAK_CABINET = DECO.register("dark_oak_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_cabinet")))));
    ...
    public static final Supplier<Item> DARK_OAK_CABINET_CUPBOARD = DECO.register("dark_oak_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> DARK_OAK_CABINET_OVEN_VENT = DECO.register("dark_oak_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> MANGROVE_COUNTER = DECO.register("mangrove_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_counter")))));
    ...
    public static final Supplier<Item> MANGROVE_COUNTER_ISLAND = DECO.register("mangrove_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_counter_island")))));
    ...
    public static final Supplier<Item> MANGROVE_COUNTER_CUPBOARD = DECO.register("mangrove_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_counter_cupboard")))));
    ...
    public static final Supplier<Item> MANGROVE_COUNTER_DRAWER = DECO.register("mangrove_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_counter_drawer")))));
    ...
    public static final Supplier<Item> MANGROVE_COUNTER_OVEN = DECO.register("mangrove_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_counter_oven")))));
    ...
    public static final Supplier<Item> MANGROVE_COUNTER_SINK = DECO.register("mangrove_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_counter_sink")))));
    ...
    public static final Supplier<Item> MANGROVE_CABINET = DECO.register("mangrove_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_cabinet")))));
    ...
    public static final Supplier<Item> MANGROVE_CABINET_CUPBOARD = DECO.register("mangrove_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> MANGROVE_CABINET_OVEN_VENT = DECO.register("mangrove_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> CHERRY_COUNTER = DECO.register("cherry_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_counter")))));
    ...
    public static final Supplier<Item> CHERRY_COUNTER_ISLAND = DECO.register("cherry_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_counter_island")))));
    ...
    public static final Supplier<Item> CHERRY_COUNTER_CUPBOARD = DECO.register("cherry_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_counter_cupboard")))));
    ...
    public static final Supplier<Item> CHERRY_COUNTER_DRAWER = DECO.register("cherry_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_counter_drawer")))));
    ...
    public static final Supplier<Item> CHERRY_COUNTER_OVEN = DECO.register("cherry_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_counter_oven")))));
    ...
    public static final Supplier<Item> CHERRY_COUNTER_SINK = DECO.register("cherry_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_counter_sink")))));
    ...
    public static final Supplier<Item> CHERRY_CABINET = DECO.register("cherry_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_cabinet")))));
    ...
    public static final Supplier<Item> CHERRY_CABINET_CUPBOARD = DECO.register("cherry_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> CHERRY_CABINET_OVEN_VENT = DECO.register("cherry_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> BAMBOO_COUNTER = DECO.register("bamboo_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_counter")))));
    ...
    public static final Supplier<Item> BAMBOO_COUNTER_ISLAND = DECO.register("bamboo_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_counter_island")))));
    ...
    public static final Supplier<Item> BAMBOO_COUNTER_CUPBOARD = DECO.register("bamboo_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_counter_cupboard")))));
    ...
    public static final Supplier<Item> BAMBOO_COUNTER_DRAWER = DECO.register("bamboo_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_counter_drawer")))));
    ...
    public static final Supplier<Item> BAMBOO_COUNTER_OVEN = DECO.register("bamboo_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_counter_oven")))));
    ...
    public static final Supplier<Item> BAMBOO_COUNTER_SINK = DECO.register("bamboo_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_counter_sink")))));
    ...
    public static final Supplier<Item> BAMBOO_CABINET = DECO.register("bamboo_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_cabinet")))));
    ...
    public static final Supplier<Item> BAMBOO_CABINET_CUPBOARD = DECO.register("bamboo_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> BAMBOO_CABINET_OVEN_VENT = DECO.register("bamboo_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> CRIMSON_COUNTER = DECO.register("crimson_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_counter")))));
    ...
    public static final Supplier<Item> CRIMSON_COUNTER_ISLAND = DECO.register("crimson_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_counter_island")))));
    ...
    public static final Supplier<Item> CRIMSON_COUNTER_CUPBOARD = DECO.register("crimson_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_counter_cupboard")))));
    ...
    public static final Supplier<Item> CRIMSON_COUNTER_DRAWER = DECO.register("crimson_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_counter_drawer")))));
    ...
    public static final Supplier<Item> CRIMSON_COUNTER_OVEN = DECO.register("crimson_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_counter_oven")))));
    ...
    public static final Supplier<Item> CRIMSON_COUNTER_SINK = DECO.register("crimson_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_counter_sink")))));
    ...
    public static final Supplier<Item> CRIMSON_CABINET = DECO.register("crimson_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_cabinet")))));
    ...
    public static final Supplier<Item> CRIMSON_CABINET_CUPBOARD = DECO.register("crimson_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> CRIMSON_CABINET_OVEN_VENT = DECO.register("crimson_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> WARPED_COUNTER = DECO.register("warped_counter",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_counter")))));
    ...
    public static final Supplier<Item> WARPED_COUNTER_ISLAND = DECO.register("warped_counter_island",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_counter_island")))));
    ...
    public static final Supplier<Item> WARPED_COUNTER_CUPBOARD = DECO.register("warped_counter_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_counter_cupboard")))));
    ...
    public static final Supplier<Item> WARPED_COUNTER_DRAWER = DECO.register("warped_counter_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_counter_drawer")))));
    ...
    public static final Supplier<Item> WARPED_COUNTER_OVEN = DECO.register("warped_counter_oven",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_counter_oven")))));
    ...
    public static final Supplier<Item> WARPED_COUNTER_SINK = DECO.register("warped_counter_sink",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_counter_sink")))));
    ...
    public static final Supplier<Item> WARPED_CABINET = DECO.register("warped_cabinet",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_cabinet")))));
    ...
    public static final Supplier<Item> WARPED_CABINET_CUPBOARD = DECO.register("warped_cabinet_cupboard",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_cabinet_cupboard")))));
    ...
    public static final Supplier<Item> WARPED_CABINET_OVEN_VENT = DECO.register("warped_cabinet_oven_vent",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_cabinet_oven_vent")))));
    ...
    public static final Supplier<Item> OAK_DRAWER = DECO.register("oak_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_drawer")))));
    ...
    public static final Supplier<Item> SPRUCE_DRAWER = DECO.register("spruce_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_drawer")))));
    ...
    public static final Supplier<Item> BIRCH_DRAWER = DECO.register("birch_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_drawer")))));
    ...
    public static final Supplier<Item> JUNGLE_DRAWER = DECO.register("jungle_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_drawer")))));
    ...
    public static final Supplier<Item> ACACIA_DRAWER = DECO.register("acacia_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_drawer")))));
    ...
    public static final Supplier<Item> DARK_OAK_DRAWER = DECO.register("dark_oak_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_drawer")))));
    ...
    public static final Supplier<Item> MANGROVE_DRAWER = DECO.register("mangrove_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_drawer")))));
    ...
    public static final Supplier<Item> CHERRY_DRAWER = DECO.register("cherry_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_drawer")))));
    ...
    public static final Supplier<Item> BAMBOO_DRAWER = DECO.register("bamboo_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_drawer")))));
    ...
    public static final Supplier<Item> CRIMSON_DRAWER = DECO.register("crimson_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_drawer")))));
    ...
    public static final Supplier<Item> WARPED_DRAWER = DECO.register("warped_drawer",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_drawer")))));
    ...
    public static final Supplier<Item> OAK_SHELF = DECO.register("oak_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_shelf")))));
    ...
    public static final Supplier<Item> SPRUCE_SHELF = DECO.register("spruce_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_shelf")))));
    ...
    public static final Supplier<Item> BIRCH_SHELF = DECO.register("birch_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_shelf")))));
    ...
    public static final Supplier<Item> JUNGLE_SHELF = DECO.register("jungle_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_shelf")))));
    ...
    public static final Supplier<Item> ACACIA_SHELF = DECO.register("acacia_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_shelf")))));
    ...
    public static final Supplier<Item> DARK_OAK_SHELF = DECO.register("dark_oak_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_shelf")))));
    ...
    public static final Supplier<Item> MANGROVE_SHELF = DECO.register("mangrove_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_shelf")))));
    ...
    public static final Supplier<Item> CHERRY_SHELF = DECO.register("cherry_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_shelf")))));
    ...
    public static final Supplier<Item> BAMBOO_SHELF = DECO.register("bamboo_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_shelf")))));
    ...
    public static final Supplier<Item> CRIMSON_SHELF = DECO.register("crimson_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_shelf")))));
    ...
    public static final Supplier<Item> WARPED_SHELF = DECO.register("warped_shelf",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_shelf")))));
    ...
    public static final Supplier<Item> OAK_MAILBOX = DECO.register("oak_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_mailbox")))));
    ...
    public static final Supplier<Item> SPRUCE_MAILBOX = DECO.register("spruce_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_mailbox")))));
    ...
    public static final Supplier<Item> BIRCH_MAILBOX = DECO.register("birch_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_mailbox")))));
    ...
    public static final Supplier<Item> JUNGLE_MAILBOX = DECO.register("jungle_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_mailbox")))));
    ...
    public static final Supplier<Item> ACACIA_MAILBOX = DECO.register("acacia_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_mailbox")))));
    ...
    public static final Supplier<Item> DARK_OAK_MAILBOX = DECO.register("dark_oak_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_mailbox")))));
    ...
    public static final Supplier<Item> MANGROVE_MAILBOX = DECO.register("mangrove_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_mailbox")))));
    ...
    public static final Supplier<Item> CHERRY_MAILBOX = DECO.register("cherry_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_mailbox")))));
    ...
    public static final Supplier<Item> BAMBOO_MAILBOX = DECO.register("bamboo_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_mailbox")))));
    ...
    public static final Supplier<Item> CRIMSON_MAILBOX = DECO.register("crimson_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_mailbox")))));
    ...
    public static final Supplier<Item> WARPED_MAILBOX = DECO.register("warped_mailbox",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_mailbox")))));
    ...
    public static final Supplier<Item> OAK_WARDROBE = DECO.register("oak_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_wardrobe")))));
    ...
    public static final Supplier<Item> SPRUCE_WARDROBE = DECO.register("spruce_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_wardrobe")))));
    ...
    public static final Supplier<Item> BIRCH_WARDROBE = DECO.register("birch_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_wardrobe")))));
    ...
    public static final Supplier<Item> JUNGLE_WARDROBE = DECO.register("jungle_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_wardrobe")))));
    ...
    public static final Supplier<Item> ACACIA_WARDROBE = DECO.register("acacia_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_wardrobe")))));
    ...
    public static final Supplier<Item> DARK_OAK_WARDROBE = DECO.register("dark_oak_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_wardrobe")))));
    ...
    public static final Supplier<Item> MANGROVE_WARDROBE = DECO.register("mangrove_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_wardrobe")))));
    ...
    public static final Supplier<Item> CHERRY_WARDROBE = DECO.register("cherry_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_wardrobe")))));
    ...
    public static final Supplier<Item> BAMBOO_WARDROBE = DECO.register("bamboo_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_wardrobe")))));
    ...
    public static final Supplier<Item> CRIMSON_WARDROBE = DECO.register("crimson_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_wardrobe")))));
    ...
    public static final Supplier<Item> WARPED_WARDROBE = DECO.register("warped_wardrobe",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_wardrobe")))));
    ...
    public static final Supplier<Item> OAK_BLINDS = DECO.register("oak_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_blinds")))));
    ...
    public static final Supplier<Item> SPRUCE_BLINDS = DECO.register("spruce_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_blinds")))));
    ...
    public static final Supplier<Item> BIRCH_BLINDS = DECO.register("birch_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_blinds")))));
    ...
    public static final Supplier<Item> JUNGLE_BLINDS = DECO.register("jungle_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_blinds")))));
    ...
    public static final Supplier<Item> ACACIA_BLINDS = DECO.register("acacia_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_blinds")))));
    ...
    public static final Supplier<Item> DARK_OAK_BLINDS = DECO.register("dark_oak_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_blinds")))));
    ...
    public static final Supplier<Item> MANGROVE_BLINDS = DECO.register("mangrove_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_blinds")))));
    ...
    public static final Supplier<Item> CHERRY_BLINDS = DECO.register("cherry_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_blinds")))));
    ...
    public static final Supplier<Item> BAMBOO_BLINDS = DECO.register("bamboo_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_blinds")))));
    ...
    public static final Supplier<Item> CRIMSON_BLINDS = DECO.register("crimson_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_blinds")))));
    ...
    public static final Supplier<Item> WARPED_BLINDS = DECO.register("warped_blinds",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_blinds")))));
    ...
    public static final Supplier<Item> OAK_TOMBSTONE = DECO.register("oak_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_tombstone")))));
    ...
    public static final Supplier<Item> SPRUCE_TOMBSTONE = DECO.register("spruce_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_tombstone")))));
    ...
    public static final Supplier<Item> BIRCH_TOMBSTONE = DECO.register("birch_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_tombstone")))));
    ...
    public static final Supplier<Item> JUNGLE_TOMBSTONE = DECO.register("jungle_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_tombstone")))));
    ...
    public static final Supplier<Item> ACACIA_TOMBSTONE = DECO.register("acacia_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_tombstone")))));
    ...
    public static final Supplier<Item> DARK_OAK_TOMBSTONE = DECO.register("dark_oak_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_tombstone")))));
    ...
    public static final Supplier<Item> MANGROVE_TOMBSTONE = DECO.register("mangrove_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_tombstone")))));
    ...
    public static final Supplier<Item> CHERRY_TOMBSTONE = DECO.register("cherry_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_tombstone")))));
    ...
    public static final Supplier<Item> BAMBOO_TOMBSTONE = DECO.register("bamboo_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_tombstone")))));
    ...
    public static final Supplier<Item> CRIMSON_TOMBSTONE = DECO.register("crimson_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_tombstone")))));
    ...
    public static final Supplier<Item> WARPED_TOMBSTONE = DECO.register("warped_tombstone",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_tombstone")))));
    ...
    public static final Supplier<Item> OAK_STAIR = DECO.register("oak_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_stair")))));
    ...
    public static final Supplier<Item> SPRUCE_STAIR = DECO.register("spruce_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_stair")))));
    ...
    public static final Supplier<Item> BIRCH_STAIR = DECO.register("birch_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_stair")))));
    ...
    public static final Supplier<Item> JUNGLE_STAIR = DECO.register("jungle_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_stair")))));
    ...
    public static final Supplier<Item> ACACIA_STAIR = DECO.register("acacia_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_stair")))));
    ...
    public static final Supplier<Item> DARK_OAK_STAIR = DECO.register("dark_oak_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_stair")))));
    ...
    public static final Supplier<Item> MANGROVE_STAIR = DECO.register("mangrove_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_stair")))));
    ...
    public static final Supplier<Item> CHERRY_STAIR = DECO.register("cherry_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_stair")))));
    ...
    public static final Supplier<Item> BAMBOO_STAIR = DECO.register("bamboo_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_stair")))));
    ...
    public static final Supplier<Item> CRIMSON_STAIR = DECO.register("crimson_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_stair")))));
    ...
    public static final Supplier<Item> WARPED_STAIR = DECO.register("warped_stair",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_stair")))));
    ...
    public static final Supplier<Item> OAK_PLATFORM = DECO.register("oak_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_platform")))));
    ...
    public static final Supplier<Item> SPRUCE_PLATFORM = DECO.register("spruce_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_platform")))));
    ...
    public static final Supplier<Item> BIRCH_PLATFORM = DECO.register("birch_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_platform")))));
    ...
    public static final Supplier<Item> JUNGLE_PLATFORM = DECO.register("jungle_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_platform")))));
    ...
    public static final Supplier<Item> ACACIA_PLATFORM = DECO.register("acacia_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_platform")))));
    ...
    public static final Supplier<Item> DARK_OAK_PLATFORM = DECO.register("dark_oak_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_platform")))));
    ...
    public static final Supplier<Item> MANGROVE_PLATFORM = DECO.register("mangrove_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_platform")))));
    ...
    public static final Supplier<Item> CHERRY_PLATFORM = DECO.register("cherry_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_platform")))));
    ...
    public static final Supplier<Item> BAMBOO_PLATFORM = DECO.register("bamboo_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_platform")))));
    ...
    public static final Supplier<Item> CRIMSON_PLATFORM = DECO.register("crimson_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_platform")))));
    ...
    public static final Supplier<Item> WARPED_PLATFORM = DECO.register("warped_platform",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_platform")))));
    ...
    public static final Supplier<Item> OAK_RAILING = DECO.register("oak_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_railing")))));
    ...
    public static final Supplier<Item> SPRUCE_RAILING = DECO.register("spruce_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_railing")))));
    ...
    public static final Supplier<Item> BIRCH_RAILING = DECO.register("birch_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_railing")))));
    ...
    public static final Supplier<Item> JUNGLE_RAILING = DECO.register("jungle_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_railing")))));
    ...
    public static final Supplier<Item> ACACIA_RAILING = DECO.register("acacia_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_railing")))));
    ...
    public static final Supplier<Item> DARK_OAK_RAILING = DECO.register("dark_oak_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_railing")))));
    ...
    public static final Supplier<Item> MANGROVE_RAILING = DECO.register("mangrove_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_railing")))));
    ...
    public static final Supplier<Item> CHERRY_RAILING = DECO.register("cherry_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_railing")))));
    ...
    public static final Supplier<Item> BAMBOO_RAILING = DECO.register("bamboo_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_railing")))));
    ...
    public static final Supplier<Item> CRIMSON_RAILING = DECO.register("crimson_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_railing")))));
    ...
    public static final Supplier<Item> WARPED_RAILING = DECO.register("warped_railing",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_railing")))));
    ...
    public static final Supplier<Item> OAK_ROOF = DECO.register("oak_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_roof")))));
    ...
    public static final Supplier<Item> OAK_ROOF_SHALLOW = DECO.register("oak_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_roof_shallow")))));
    ...
    public static final Supplier<Item> OAK_ROOF_STEEP = DECO.register("oak_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_roof_steep")))));
    ...
    public static final Supplier<Item> SPRUCE_ROOF = DECO.register("spruce_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_roof")))));
    ...
    public static final Supplier<Item> SPRUCE_ROOF_SHALLOW = DECO.register("spruce_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_roof_shallow")))));
    ...
    public static final Supplier<Item> SPRUCE_ROOF_STEEP = DECO.register("spruce_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_roof_steep")))));
    ...
    public static final Supplier<Item> BIRCH_ROOF = DECO.register("birch_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_roof")))));
    ...
    public static final Supplier<Item> BIRCH_ROOF_SHALLOW = DECO.register("birch_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_roof_shallow")))));
    ...
    public static final Supplier<Item> BIRCH_ROOF_STEEP = DECO.register("birch_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_roof_steep")))));
    ...
    public static final Supplier<Item> JUNGLE_ROOF = DECO.register("jungle_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_roof")))));
    ...
    public static final Supplier<Item> JUNGLE_ROOF_SHALLOW = DECO.register("jungle_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_roof_shallow")))));
    ...
    public static final Supplier<Item> JUNGLE_ROOF_STEEP = DECO.register("jungle_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_roof_steep")))));
    ...
    public static final Supplier<Item> ACACIA_ROOF = DECO.register("acacia_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_roof")))));
    ...
    public static final Supplier<Item> ACACIA_ROOF_SHALLOW = DECO.register("acacia_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_roof_shallow")))));
    ...
    public static final Supplier<Item> ACACIA_ROOF_STEEP = DECO.register("acacia_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_roof_steep")))));
    ...
    public static final Supplier<Item> DARK_OAK_ROOF = DECO.register("dark_oak_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_roof")))));
    ...
    public static final Supplier<Item> DARK_OAK_ROOF_SHALLOW = DECO.register("dark_oak_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_roof_shallow")))));
    ...
    public static final Supplier<Item> DARK_OAK_ROOF_STEEP = DECO.register("dark_oak_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_roof_steep")))));
    ...
    public static final Supplier<Item> MANGROVE_ROOF = DECO.register("mangrove_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_roof")))));
    ...
    public static final Supplier<Item> MANGROVE_ROOF_SHALLOW = DECO.register("mangrove_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_roof_shallow")))));
    ...
    public static final Supplier<Item> MANGROVE_ROOF_STEEP = DECO.register("mangrove_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_roof_steep")))));
    ...
    public static final Supplier<Item> CHERRY_ROOF = DECO.register("cherry_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_roof")))));
    ...
    public static final Supplier<Item> CHERRY_ROOF_SHALLOW = DECO.register("cherry_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_roof_shallow")))));
    ...
    public static final Supplier<Item> CHERRY_ROOF_STEEP = DECO.register("cherry_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_roof_steep")))));
    ...
    public static final Supplier<Item> BAMBOO_ROOF = DECO.register("bamboo_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_roof")))));
    ...
    public static final Supplier<Item> BAMBOO_ROOF_SHALLOW = DECO.register("bamboo_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_roof_shallow")))));
    ...
    public static final Supplier<Item> BAMBOO_ROOF_STEEP = DECO.register("bamboo_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_roof_steep")))));
    ...
    public static final Supplier<Item> CRIMSON_ROOF = DECO.register("crimson_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_roof")))));
    ...
    public static final Supplier<Item> CRIMSON_ROOF_SHALLOW = DECO.register("crimson_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_roof_shallow")))));
    ...
    public static final Supplier<Item> CRIMSON_ROOF_STEEP = DECO.register("crimson_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_roof_steep")))));
    ...
    public static final Supplier<Item> WARPED_ROOF = DECO.register("warped_roof",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_roof")))));
    ...
    public static final Supplier<Item> WARPED_ROOF_SHALLOW = DECO.register("warped_roof_shallow",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_roof_shallow")))));
    ...
    public static final Supplier<Item> WARPED_ROOF_STEEP = DECO.register("warped_roof_steep",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_roof_steep")))));
    ...
    public static final Supplier<Item> BOOKSHELF_HIDDEN_DOOR = DECO.register("bookshelf_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bookshelf_hidden_door")))));
    ...
    public static final Supplier<Item> OAK_HIDDEN_DOOR = DECO.register("oak_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_planks_hidden_door")))));
    ...
    public static final Supplier<Item> SPRUCE_HIDDEN_DOOR = DECO.register("spruce_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_planks_hidden_door")))));
    ...
    public static final Supplier<Item> BIRCH_HIDDEN_DOOR = DECO.register("birch_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_planks_hidden_door")))));
    ...
    public static final Supplier<Item> JUNGLE_HIDDEN_DOOR = DECO.register("jungle_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_planks_hidden_door")))));
    ...
    public static final Supplier<Item> ACACIA_HIDDEN_DOOR = DECO.register("acacia_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_planks_hidden_door")))));
    ...
    public static final Supplier<Item> DARK_OAK_HIDDEN_DOOR = DECO.register("dark_oak_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_planks_hidden_door")))));
    ...
    public static final Supplier<Item> MANGROVE_HIDDEN_DOOR = DECO.register("mangrove_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_planks_hidden_door")))));
    ...
    public static final Supplier<Item> CHERRY_HIDDEN_DOOR = DECO.register("cherry_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_planks_hidden_door")))));
    ...
    public static final Supplier<Item> BAMBOO_HIDDEN_DOOR = DECO.register("bamboo_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_planks_hidden_door")))));
    ...
    public static final Supplier<Item> CRIMSON_HIDDEN_DOOR = DECO.register("crimson_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_planks_hidden_door")))));
    ...
    public static final Supplier<Item> WARPED_HIDDEN_DOOR = DECO.register("warped_planks_hidden_door",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_planks_hidden_door")))));
    ...
    public static final Supplier<Item> OAK_UPGRADED_FENCE = DECO.register("oak_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_upgraded_fence")))));
    ...
    public static final Supplier<Item> OAK_UPGRADED_FENCE_GATE = DECO.register("oak_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> SPRUCE_UPGRADED_FENCE = DECO.register("spruce_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_upgraded_fence")))));
    ...
    public static final Supplier<Item> SPRUCE_UPGRADED_FENCE_GATE = DECO.register("spruce_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> BIRCH_UPGRADED_FENCE = DECO.register("birch_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_upgraded_fence")))));
    ...
    public static final Supplier<Item> BIRCH_UPGRADED_FENCE_GATE = DECO.register("birch_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> JUNGLE_UPGRADED_FENCE = DECO.register("jungle_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_upgraded_fence")))));
    ...
    public static final Supplier<Item> JUNGLE_UPGRADED_FENCE_GATE = DECO.register("jungle_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> ACACIA_UPGRADED_FENCE = DECO.register("acacia_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_upgraded_fence")))));
    ...
    public static final Supplier<Item> ACACIA_UPGRADED_FENCE_GATE = DECO.register("acacia_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> DARK_OAK_UPGRADED_FENCE = DECO.register("dark_oak_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_upgraded_fence")))));
    ...
    public static final Supplier<Item> DARK_OAK_UPGRADED_FENCE_GATE = DECO.register("dark_oak_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> MANGROVE_UPGRADED_FENCE = DECO.register("mangrove_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_upgraded_fence")))));
    ...
    public static final Supplier<Item> MANGROVE_UPGRADED_FENCE_GATE = DECO.register("mangrove_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> CHERRY_UPGRADED_FENCE = DECO.register("cherry_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_upgraded_fence")))));
    ...
    public static final Supplier<Item> CHERRY_UPGRADED_FENCE_GATE = DECO.register("cherry_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> BAMBOO_UPGRADED_FENCE = DECO.register("bamboo_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_upgraded_fence")))));
    ...
    public static final Supplier<Item> BAMBOO_UPGRADED_FENCE_GATE = DECO.register("bamboo_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> CRIMSON_UPGRADED_FENCE = DECO.register("crimson_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_upgraded_fence")))));
    ...
    public static final Supplier<Item> CRIMSON_UPGRADED_FENCE_GATE = DECO.register("crimson_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> WARPED_UPGRADED_FENCE = DECO.register("warped_upgraded_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_upgraded_fence")))));
    ...
    public static final Supplier<Item> WARPED_UPGRADED_FENCE_GATE = DECO.register("warped_upgraded_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_upgraded_fence_gate")))));
    ...
    public static final Supplier<Item> OAK_CHAIN_LINK_FENCE = DECO.register("oak_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_chain_link_fence")))));
    ...
    public static final Supplier<Item> OAK_CHAIN_LINK_FENCE_GATE = DECO.register("oak_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> SPRUCE_CHAIN_LINK_FENCE = DECO.register("spruce_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_chain_link_fence")))));
    ...
    public static final Supplier<Item> SPRUCE_CHAIN_LINK_FENCE_GATE = DECO.register("spruce_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> BIRCH_CHAIN_LINK_FENCE = DECO.register("birch_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_chain_link_fence")))));
    ...
    public static final Supplier<Item> BIRCH_CHAIN_LINK_FENCE_GATE = DECO.register("birch_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> JUNGLE_CHAIN_LINK_FENCE = DECO.register("jungle_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_chain_link_fence")))));
    ...
    public static final Supplier<Item> JUNGLE_CHAIN_LINK_FENCE_GATE = DECO.register("jungle_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> ACACIA_CHAIN_LINK_FENCE = DECO.register("acacia_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_chain_link_fence")))));
    ...
    public static final Supplier<Item> ACACIA_CHAIN_LINK_FENCE_GATE = DECO.register("acacia_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> DARK_OAK_CHAIN_LINK_FENCE = DECO.register("dark_oak_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_chain_link_fence")))));
    ...
    public static final Supplier<Item> DARK_OAK_CHAIN_LINK_FENCE_GATE = DECO.register("dark_oak_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> MANGROVE_CHAIN_LINK_FENCE = DECO.register("mangrove_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_chain_link_fence")))));
    ...
    public static final Supplier<Item> MANGROVE_CHAIN_LINK_FENCE_GATE = DECO.register("mangrove_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> CHERRY_CHAIN_LINK_FENCE = DECO.register("cherry_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_chain_link_fence")))));
    ...
    public static final Supplier<Item> CHERRY_CHAIN_LINK_FENCE_GATE = DECO.register("cherry_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> BAMBOO_CHAIN_LINK_FENCE = DECO.register("bamboo_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_chain_link_fence")))));
    ...
    public static final Supplier<Item> BAMBOO_CHAIN_LINK_FENCE_GATE = DECO.register("bamboo_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> CRIMSON_CHAIN_LINK_FENCE = DECO.register("crimson_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_chain_link_fence")))));
    ...
    public static final Supplier<Item> CRIMSON_CHAIN_LINK_FENCE_GATE = DECO.register("crimson_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> WARPED_CHAIN_LINK_FENCE = DECO.register("warped_chain_link_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_chain_link_fence")))));
    ...
    public static final Supplier<Item> WARPED_CHAIN_LINK_FENCE_GATE = DECO.register("warped_chain_link_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_chain_link_fence_gate")))));
    ...
    public static final Supplier<Item> OAK_LOG_FENCE = DECO.register("oak_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_log_fence")))));
    ...
    public static final Supplier<Item> OAK_LOG_FENCE_GATE = DECO.register("oak_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_log_fence_gate")))));
    ...
    public static final Supplier<Item> SPRUCE_LOG_FENCE = DECO.register("spruce_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_log_fence")))));
    ...
    public static final Supplier<Item> SPRUCE_LOG_FENCE_GATE = DECO.register("spruce_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_log_fence_gate")))));
    ...
    public static final Supplier<Item> BIRCH_LOG_FENCE = DECO.register("birch_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_log_fence")))));
    ...
    public static final Supplier<Item> BIRCH_LOG_FENCE_GATE = DECO.register("birch_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_log_fence_gate")))));
    ...
    public static final Supplier<Item> JUNGLE_LOG_FENCE = DECO.register("jungle_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_log_fence")))));
    ...
    public static final Supplier<Item> JUNGLE_LOG_FENCE_GATE = DECO.register("jungle_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_log_fence_gate")))));
    ...
    public static final Supplier<Item> ACACIA_LOG_FENCE = DECO.register("acacia_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_log_fence")))));
    ...
    public static final Supplier<Item> ACACIA_LOG_FENCE_GATE = DECO.register("acacia_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_log_fence_gate")))));
    ...
    public static final Supplier<Item> DARK_OAK_LOG_FENCE = DECO.register("dark_oak_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_log_fence")))));
    ...
    public static final Supplier<Item> DARK_OAK_LOG_FENCE_GATE = DECO.register("dark_oak_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_log_fence_gate")))));
    ...
    public static final Supplier<Item> MANGROVE_LOG_FENCE = DECO.register("mangrove_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_log_fence")))));
    ...
    public static final Supplier<Item> MANGROVE_LOG_FENCE_GATE = DECO.register("mangrove_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_log_fence_gate")))));
    ...
    public static final Supplier<Item> CHERRY_LOG_FENCE = DECO.register("cherry_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_log_fence")))));
    ...
    public static final Supplier<Item> CHERRY_LOG_FENCE_GATE = DECO.register("cherry_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_log_fence_gate")))));
    ...
    public static final Supplier<Item> BAMBOO_LOG_FENCE = DECO.register("bamboo_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_log_fence")))));
    ...
    public static final Supplier<Item> BAMBOO_LOG_FENCE_GATE = DECO.register("bamboo_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_log_fence_gate")))));
    ...
    public static final Supplier<Item> CRIMSON_LOG_FENCE = DECO.register("crimson_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_log_fence")))));
    ...
    public static final Supplier<Item> CRIMSON_LOG_FENCE_GATE = DECO.register("crimson_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_log_fence_gate")))));
    ...
    public static final Supplier<Item> WARPED_LOG_FENCE = DECO.register("warped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_log_fence")))));
    ...
    public static final Supplier<Item> WARPED_LOG_FENCE_GATE = DECO.register("warped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_log_fence_gate")))));
    ...
    public static final Supplier<Item> OAK_STRIPPED_LOG_FENCE = DECO.register("oak_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_stripped_log_fence")))));
    ...
    public static final Supplier<Item> OAK_STRIPPED_LOG_FENCE_GATE = DECO.register("oak_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> SPRUCE_STRIPPED_LOG_FENCE = DECO.register("spruce_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_stripped_log_fence")))));
    ...
    public static final Supplier<Item> SPRUCE_STRIPPED_LOG_FENCE_GATE = DECO.register("spruce_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> BIRCH_STRIPPED_LOG_FENCE = DECO.register("birch_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_stripped_log_fence")))));
    ...
    public static final Supplier<Item> BIRCH_STRIPPED_LOG_FENCE_GATE = DECO.register("birch_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> JUNGLE_STRIPPED_LOG_FENCE = DECO.register("jungle_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_stripped_log_fence")))));
    ...
    public static final Supplier<Item> JUNGLE_STRIPPED_LOG_FENCE_GATE = DECO.register("jungle_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> ACACIA_STRIPPED_LOG_FENCE = DECO.register("acacia_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_stripped_log_fence")))));
    ...
    public static final Supplier<Item> ACACIA_STRIPPED_LOG_FENCE_GATE = DECO.register("acacia_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> DARK_OAK_STRIPPED_LOG_FENCE = DECO.register("dark_oak_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_stripped_log_fence")))));
    ...
    public static final Supplier<Item> DARK_OAK_STRIPPED_LOG_FENCE_GATE = DECO.register("dark_oak_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> MANGROVE_STRIPPED_LOG_FENCE = DECO.register("mangrove_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_stripped_log_fence")))));
    ...
    public static final Supplier<Item> MANGROVE_STRIPPED_LOG_FENCE_GATE = DECO.register("mangrove_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> CHERRY_STRIPPED_LOG_FENCE = DECO.register("cherry_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_stripped_log_fence")))));
    ...
    public static final Supplier<Item> CHERRY_STRIPPED_LOG_FENCE_GATE = DECO.register("cherry_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> BAMBOO_STRIPPED_LOG_FENCE = DECO.register("bamboo_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_stripped_log_fence")))));
    ...
    public static final Supplier<Item> BAMBOO_STRIPPED_LOG_FENCE_GATE = DECO.register("bamboo_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> CRIMSON_STRIPPED_LOG_FENCE = DECO.register("crimson_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_stripped_log_fence")))));
    ...
    public static final Supplier<Item> CRIMSON_STRIPPED_LOG_FENCE_GATE = DECO.register("crimson_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> WARPED_STRIPPED_LOG_FENCE = DECO.register("warped_stripped_log_fence",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_stripped_log_fence")))));
    ...
    public static final Supplier<Item> WARPED_STRIPPED_LOG_FENCE_GATE = DECO.register("warped_stripped_log_fence_gate",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_stripped_log_fence_gate")))));
    ...
    public static final Supplier<Item> OAK_BUSH = DECO.register("oak_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_bush")))));
    ...
    public static final Supplier<Item> SPRUCE_BUSH = DECO.register("spruce_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_bush")))));
    ...
    public static final Supplier<Item> BIRCH_BUSH = DECO.register("birch_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_bush")))));
    ...
    public static final Supplier<Item> JUNGLE_BUSH = DECO.register("jungle_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_bush")))));
    ...
    public static final Supplier<Item> ACACIA_BUSH = DECO.register("acacia_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_bush")))));
    ...
    public static final Supplier<Item> DARK_OAK_BUSH = DECO.register("dark_oak_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_bush")))));
    ...
    public static final Supplier<Item> MANGROVE_BUSH = DECO.register("mangrove_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_bush")))));
    ...
    public static final Supplier<Item> CHERRY_BUSH = DECO.register("cherry_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_bush")))));
    ...
    public static final Supplier<Item> CRIMSON_BUSH = DECO.register("crimson_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_bush")))));
    ...
    public static final Supplier<Item> WARPED_BUSH = DECO.register("warped_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_bush")))));
    ...
    public static final Supplier<Item> AZALEA_BUSH = DECO.register("azalea_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("azalea_bush")))));
    ...
    public static final Supplier<Item> FLOWERING_AZALEA_BUSH = DECO.register("flowering_azalea_bush",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("flowering_azalea_bush")))));
    ...
    public static final Supplier<Item> OAK_HOLLOW_LOG = DECO.register("oak_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_hollow_log")))));
    ...
    public static final Supplier<Item> OAK_HOLLOW_STRIPPED_LOG = DECO.register("oak_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> SPRUCE_HOLLOW_LOG = DECO.register("spruce_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_hollow_log")))));
    ...
    public static final Supplier<Item> SPRUCE_HOLLOW_STRIPPED_LOG = DECO.register("spruce_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> BIRCH_HOLLOW_LOG = DECO.register("birch_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_hollow_log")))));
    ...
    public static final Supplier<Item> BIRCH_HOLLOW_STRIPPED_LOG = DECO.register("birch_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> JUNGLE_HOLLOW_LOG = DECO.register("jungle_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_hollow_log")))));
    ...
    public static final Supplier<Item> JUNGLE_HOLLOW_STRIPPED_LOG = DECO.register("jungle_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> ACACIA_HOLLOW_LOG = DECO.register("acacia_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_hollow_log")))));
    ...
    public static final Supplier<Item> ACACIA_HOLLOW_STRIPPED_LOG = DECO.register("acacia_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> DARK_OAK_HOLLOW_LOG = DECO.register("dark_oak_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_hollow_log")))));
    ...
    public static final Supplier<Item> DARK_OAK_HOLLOW_STRIPPED_LOG = DECO.register("dark_oak_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> MANGROVE_HOLLOW_LOG = DECO.register("mangrove_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_hollow_log")))));
    ...
    public static final Supplier<Item> MANGROVE_HOLLOW_STRIPPED_LOG = DECO.register("mangrove_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> CHERRY_HOLLOW_LOG = DECO.register("cherry_hollow_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_hollow_log")))));
    ...
    public static final Supplier<Item> CHERRY_HOLLOW_STRIPPED_LOG = DECO.register("cherry_hollow_stripped_log",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_hollow_stripped_log")))));
    ...
    public static final Supplier<Item> BAMBOO_HOLLOW_BLOCK = DECO.register("bamboo_hollow_block",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_hollow_block")))));
    ...
    public static final Supplier<Item> BAMBOO_HOLLOW_STRIPPED_BLOCK = DECO.register("bamboo_hollow_stripped_block",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_hollow_stripped_block")))));
    ...
    public static final Supplier<Item> CRIMSON_HOLLOW_STEM = DECO.register("crimson_hollow_stem",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_hollow_stem")))));
    ...
    public static final Supplier<Item> CRIMSON_HOLLOW_STRIPPED_STEM = DECO.register("crimson_hollow_stripped_stem",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_hollow_stripped_stem")))));
    ...
    public static final Supplier<Item> WARPED_HOLLOW_STEM = DECO.register("warped_hollow_stem",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_hollow_stem")))));
    ...
    public static final Supplier<Item> WARPED_HOLLOW_STRIPPED_STEM = DECO.register("warped_hollow_stripped_stem",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_hollow_stripped_stem")))));
    ...
    public static final Supplier<Item> OAK_LAMP = DECO.register("oak_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("oak_lamp")))));
    ...
    public static final Supplier<Item> SPRUCE_LAMP = DECO.register("spruce_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("spruce_lamp")))));
    ...
    public static final Supplier<Item> BIRCH_LAMP = DECO.register("birch_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("birch_lamp")))));
    ...
    public static final Supplier<Item> JUNGLE_LAMP = DECO.register("jungle_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("jungle_lamp")))));
    ...
    public static final Supplier<Item> ACACIA_LAMP = DECO.register("acacia_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("acacia_lamp")))));
    ...
    public static final Supplier<Item> DARK_OAK_LAMP = DECO.register("dark_oak_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("dark_oak_lamp")))));
    ...
    public static final Supplier<Item> MANGROVE_LAMP = DECO.register("mangrove_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("mangrove_lamp")))));
    ...
    public static final Supplier<Item> CHERRY_LAMP = DECO.register("cherry_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cherry_lamp")))));
    ...
    public static final Supplier<Item> BAMBOO_LAMP = DECO.register("bamboo_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("bamboo_lamp")))));
    ...
    public static final Supplier<Item> CRIMSON_LAMP = DECO.register("crimson_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("crimson_lamp")))));
    ...
    public static final Supplier<Item> WARPED_LAMP = DECO.register("warped_lamp",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("warped_lamp")))));
    ...
    public static final Supplier<Item> WHITE_RUG = DECO.register("white_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("white_rug")))));
    ...
    public static final Supplier<Item> LIGHT_GRAY_RUG = DECO.register("light_gray_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("light_gray_rug")))));
    ...
    public static final Supplier<Item> GRAY_RUG = DECO.register("gray_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("gray_rug")))));
    ...
    public static final Supplier<Item> BLACK_RUG = DECO.register("black_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("black_rug")))));
    ...
    public static final Supplier<Item> BROWN_RUG = DECO.register("brown_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("brown_rug")))));

    public static final Supplier<Item> RED_RUG = DECO.register("red_rug",
            () -> new BlockItem(ModBlocks.RED_RUG.get(), new Item.Properties()
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("red_rug")))));
    ...
    public static final Supplier<Item> ORANGE_RUG = DECO.register("orange_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("orange_rug")))));
    ...
    public static final Supplier<Item> YELLOW_RUG = DECO.register("yellow_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("yellow_rug")))));
    ...
    public static final Supplier<Item> LIME_RUG = DECO.register("lime_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("lime_rug")))));
    ...
    public static final Supplier<Item> GREEN_RUG = DECO.register("green_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("green_rug")))));
    ...
    public static final Supplier<Item> CYAN_RUG = DECO.register("cyan_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("cyan_rug")))));
    ...
    public static final Supplier<Item> LIGHT_BLUE_RUG = DECO.register("light_blue_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("light_blue_rug")))));
    ...
    public static final Supplier<Item> BLUE_RUG = DECO.register("blue_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("blue_rug")))));
    ...
    public static final Supplier<Item> PURPLE_RUG = DECO.register("purple_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("purple_rug")))));
    ...
    public static final Supplier<Item> MAGENTA_RUG = DECO.register("magenta_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("magenta_rug")))));
    ...
    public static final Supplier<Item> PINK_RUG = DECO.register("pink_rug",
            ...
            .setId(ResourceKey.create(Registries.ITEM, LYIVXsFurnitureMod.createResourceLocation("pink_rug")))));
