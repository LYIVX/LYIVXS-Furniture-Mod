...
public class ModBlockStateProperties {
    ...
    public static final DirectionProperty FACING = DirectionProperty.createAll("facing");
    public static final DirectionProperty FACING_HORIZONTAL = DirectionProperty.createHorizontal("facing");
