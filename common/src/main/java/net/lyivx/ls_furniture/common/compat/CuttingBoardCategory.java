...
public class CuttingBoardCategory extends BaseCategory<CuttingBoardRecipe> {
    ...
    public static final ResourceLocation ID = new ResourceLocation(LYIVXsFurnitureMod.MOD_ID, "cutting_board");
    public static final RecipeType<CuttingBoardRecipe> CUTTING_BOARD_RECIPE_TYPE = new RecipeType<>(ID, CuttingBoardRecipe.class);
    public static final ResourceLocation GUI_BACK = new ResourceLocation(LYIVXsFurnitureMod.MOD_ID, "textures/gui/container/cutting_board.png");
