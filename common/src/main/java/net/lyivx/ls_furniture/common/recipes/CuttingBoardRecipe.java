        ...
        public Serializer() {
            this.mapCodec = RecordCodecBuilder.mapCodec(
                    instance -> instance.group(
                                    ...
                                    ItemStack.STRICT_CODEC.fieldOf("result").forGetter(CuttingBoardRecipe::result),
                                    ExtraCodecs.POSITIVE_INT.fieldOf("uses").orElse(5).forGetter(CuttingBoardRecipe::getUses)
                            )
                            .apply(instance, CuttingBoardRecipe::new)
            );
            this.streamCodec = StreamCodec.composite(
                    ByteBufCodecs.STRING_UTF8, CuttingBoardRecipe::group,
                    Ingredient.CONTENTS_STREAM_CODEC, CuttingBoardRecipe::input,
                    ItemStack.STREAM_CODEC, CuttingBoardRecipe::result,
                    ByteBufCodecs.VAR_INT, CuttingBoardRecipe::getUses,
