...
public class DeskMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DeskMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.DESK.get(), id);
