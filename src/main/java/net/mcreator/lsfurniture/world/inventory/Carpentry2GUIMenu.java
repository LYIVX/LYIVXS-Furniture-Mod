...
import net.mcreator.lsfurniture.procedures.Carpentry2ProProcedure;
import net.mcreator.lsfurniture.network.Carpentry2GUISlotMessage;
...
public class Carpentry2GUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Carpentry2GUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new Carpentry2GUISlotMessage(slotid, x, y, z, ctype, meta));
			Carpentry2GUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof Carpentry2GUIMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			Carpentry2ProProcedure.execute(world, x, y, z, entity);
		}
	}
}
