...
public class MailBoxMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MailBoxMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.MAIL_BOX.get(), id);
