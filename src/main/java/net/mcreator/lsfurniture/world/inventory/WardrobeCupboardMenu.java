...
public class WardrobeCupboardMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WardrobeCupboardMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.WARDROBE_CUPBOARD.get(), id);
