...
import net.mcreator.lsfurniture.procedures.WeaveryProProcedure;
import net.mcreator.lsfurniture.procedures.WeaveryGUIThisGUIIsClosedProcedure;
import net.mcreator.lsfurniture.network.WeaveryGUISlotMessage;
...
public class WeaveryGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WeaveryGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.WEAVERY_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		WeaveryGUIThisGUIIsClosedProcedure.execute(entity);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new WeaveryGUISlotMessage(slotid, x, y, z, ctype, meta));
			WeaveryGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof WeaveryGUIMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			WeaveryProProcedure.execute(world, x, y, z, entity);
		}
	}
}
