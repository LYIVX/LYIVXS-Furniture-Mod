...
import net.mcreator.lsfurniture.procedures.EngineeringProProcedure;
import net.mcreator.lsfurniture.procedures.EngineeringGUIThisGUIIsClosedProcedure;
import net.mcreator.lsfurniture.network.EngineeringGUISlotMessage;
...
public class EngineeringGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EngineeringGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.ENGINEERING_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		EngineeringGUIThisGUIIsClosedProcedure.execute(entity);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUISlotMessage(slotid, x, y, z, ctype, meta));
			EngineeringGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof EngineeringGUIMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			EngineeringProProcedure.execute(world, x, y, z, entity);
		}
	}
}
