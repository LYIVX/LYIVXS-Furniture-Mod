...
public class CupboardMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CupboardMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.CUPBOARD.get(), id);
