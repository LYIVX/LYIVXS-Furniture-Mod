...
public class MetalurgyGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MetalurgyGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.METALURGY_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		MetalurgyGUIThisGUIIsClosedProcedure.execute(entity);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUISlotMessage(slotid, x, y, z, ctype, meta));
			MetalurgyGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof MetalurgyGUIMenu) {
