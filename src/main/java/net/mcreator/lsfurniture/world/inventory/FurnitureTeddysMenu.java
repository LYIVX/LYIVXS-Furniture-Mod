...
public class FurnitureTeddysMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurnitureTeddysMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof FurnitureTeddysMenu) {
