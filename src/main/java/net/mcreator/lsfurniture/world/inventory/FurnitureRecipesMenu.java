...
public class FurnitureRecipesMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurnitureRecipesMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.FURNITURE_RECIPES.get(), id);
