...
public class FreezerMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FreezerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.FREEZER.get(), id);
