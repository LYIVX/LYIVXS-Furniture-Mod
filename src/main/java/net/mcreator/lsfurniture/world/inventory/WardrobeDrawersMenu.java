...
public class WardrobeDrawersMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WardrobeDrawersMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.WARDROBE_DRAWERS.get(), id);
