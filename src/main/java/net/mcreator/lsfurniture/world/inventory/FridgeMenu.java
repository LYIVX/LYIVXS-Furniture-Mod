...
public class FridgeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FridgeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.FRIDGE.get(), id);
