...
public class BotanistGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BotanistGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.BOTANIST_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		BotanistGUIThisGUIIsClosedProcedure.execute(entity);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new BotanistGUISlotMessage(slotid, x, y, z, ctype, meta));
			BotanistGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof BotanistGUIMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			BotanistProProcedure.execute(world, x, y, z, entity);
		}
	}
}
