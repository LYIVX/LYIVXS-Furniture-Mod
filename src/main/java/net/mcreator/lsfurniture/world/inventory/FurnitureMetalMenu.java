...
import net.mcreator.lsfurniture.network.FurnitureMetalSlotMessage;
...
public class FurnitureMetalMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurnitureMetalMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.FURNITURE_METAL.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurnitureMetalSlotMessage(slotid, x, y, z, ctype, meta));
			FurnitureMetalSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof FurnitureMetalMenu) {
