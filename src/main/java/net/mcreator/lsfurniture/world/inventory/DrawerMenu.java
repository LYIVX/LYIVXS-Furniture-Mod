...
public class DrawerMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public DrawerMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.DRAWER.get(), id);
