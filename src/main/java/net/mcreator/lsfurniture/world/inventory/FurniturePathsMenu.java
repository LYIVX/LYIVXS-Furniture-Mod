...
import net.mcreator.lsfurniture.procedures.FurniturePathsGUIIsOpenedProcedure;
...
public class FurniturePathsMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurniturePathsMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.FURNITURE_PATHS.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof FurniturePathsMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			FurniturePathsGUIIsOpenedProcedure.execute(entity);
		}
	}
}
