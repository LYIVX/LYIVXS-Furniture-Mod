...
public class FurnitureStoneMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurnitureStoneMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.FURNITURE_STONE.get(), id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof FurnitureStoneMenu) {
