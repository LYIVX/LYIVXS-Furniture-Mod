...
public class MasonryGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public MasonryGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LsFurnitureModMenus.MASONRY_GUI.get(), id);
	...
	public void removed(Player playerIn) {
		...
		MasonryGUIThisGUIIsClosedProcedure.execute(entity);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			LsFurnitureMod.PACKET_HANDLER.sendToServer(new MasonryGUISlotMessage(slotid, x, y, z, ctype, meta));
			MasonryGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof MasonryGUIMenu) {
