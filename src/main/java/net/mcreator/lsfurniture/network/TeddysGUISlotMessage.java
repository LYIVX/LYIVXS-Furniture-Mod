...
public class TeddysGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public TeddysGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public TeddysGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(TeddysGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(TeddysGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(TeddysGUISlotMessage.class, TeddysGUISlotMessage::buffer, TeddysGUISlotMessage::new, TeddysGUISlotMessage::handler);
	}
}
