...
public class EngineeringGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public EngineeringGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public EngineeringGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(EngineeringGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(EngineeringGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(EngineeringGUISlotMessage.class, EngineeringGUISlotMessage::buffer, EngineeringGUISlotMessage::new, EngineeringGUISlotMessage::handler);
	}
}
