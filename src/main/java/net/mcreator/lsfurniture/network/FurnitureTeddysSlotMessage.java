...
public class FurnitureTeddysSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public FurnitureTeddysSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public FurnitureTeddysSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(FurnitureTeddysSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FurnitureTeddysSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(FurnitureTeddysSlotMessage.class, FurnitureTeddysSlotMessage::buffer, FurnitureTeddysSlotMessage::new, FurnitureTeddysSlotMessage::handler);
	}
}
