...
public class WoodGUIButtonMessage {
	private final int buttonID, x, y, z;

	public WoodGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public WoodGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(WoodGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WoodGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(WoodGUIButtonMessage.class, WoodGUIButtonMessage::buffer, WoodGUIButtonMessage::new, WoodGUIButtonMessage::handler);
	}
}
