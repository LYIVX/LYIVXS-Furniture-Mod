...
public class WoodGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public WoodGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public WoodGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(WoodGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WoodGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = WoodGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(WoodGUISlotMessage.class, WoodGUISlotMessage::buffer, WoodGUISlotMessage::new, WoodGUISlotMessage::handler);
	}
}
