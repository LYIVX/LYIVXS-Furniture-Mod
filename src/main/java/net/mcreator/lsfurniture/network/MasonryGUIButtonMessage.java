...
public class MasonryGUIButtonMessage {
	private final int buttonID, x, y, z;

	public MasonryGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public MasonryGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(MasonryGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MasonryGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(MasonryGUIButtonMessage.class, MasonryGUIButtonMessage::buffer, MasonryGUIButtonMessage::new, MasonryGUIButtonMessage::handler);
	}
}
