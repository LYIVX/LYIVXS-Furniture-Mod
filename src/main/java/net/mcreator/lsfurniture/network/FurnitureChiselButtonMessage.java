...
public class FurnitureChiselButtonMessage {
	private final int buttonID, x, y, z;

	public FurnitureChiselButtonMessage(FriendlyByteBuf buffer) {
	...
	public FurnitureChiselButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(FurnitureChiselButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FurnitureChiselButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(FurnitureChiselButtonMessage.class, FurnitureChiselButtonMessage::buffer, FurnitureChiselButtonMessage::new, FurnitureChiselButtonMessage::handler);
	}
}
