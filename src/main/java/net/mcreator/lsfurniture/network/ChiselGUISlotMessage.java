...
public class ChiselGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public ChiselGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public ChiselGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(ChiselGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ChiselGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = ChiselGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(ChiselGUISlotMessage.class, ChiselGUISlotMessage::buffer, ChiselGUISlotMessage::new, ChiselGUISlotMessage::handler);
	}
}
