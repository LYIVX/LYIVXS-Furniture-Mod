...
public class ChiselGUIButtonMessage {
	...
	public ChiselGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public ChiselGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(ChiselGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(ChiselGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(ChiselGUIButtonMessage.class, ChiselGUIButtonMessage::buffer, ChiselGUIButtonMessage::new, ChiselGUIButtonMessage::handler);
	}
}
