...
public class MetalurgyGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public MetalurgyGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public MetalurgyGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(MetalurgyGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MetalurgyGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(MetalurgyGUISlotMessage.class, MetalurgyGUISlotMessage::buffer, MetalurgyGUISlotMessage::new, MetalurgyGUISlotMessage::handler);
	}
}
