...
public class GlassblowerGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public GlassblowerGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public GlassblowerGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(GlassblowerGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(GlassblowerGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(GlassblowerGUISlotMessage.class, GlassblowerGUISlotMessage::buffer, GlassblowerGUISlotMessage::new, GlassblowerGUISlotMessage::handler);
	}
}
