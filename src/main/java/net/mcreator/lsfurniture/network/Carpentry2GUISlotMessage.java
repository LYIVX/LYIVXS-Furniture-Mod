...
public class Carpentry2GUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public Carpentry2GUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public Carpentry2GUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(Carpentry2GUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(Carpentry2GUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(Carpentry2GUISlotMessage.class, Carpentry2GUISlotMessage::buffer, Carpentry2GUISlotMessage::new, Carpentry2GUISlotMessage::handler);
	}
}
