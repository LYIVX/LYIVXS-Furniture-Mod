...
public class MasonryGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public MasonryGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public MasonryGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(MasonryGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MasonryGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = MasonryGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(MasonryGUISlotMessage.class, MasonryGUISlotMessage::buffer, MasonryGUISlotMessage::new, MasonryGUISlotMessage::handler);
	}
}
