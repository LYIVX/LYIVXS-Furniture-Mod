...
public class FurnitureMetalSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public FurnitureMetalSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public FurnitureMetalSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(FurnitureMetalSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FurnitureMetalSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(FurnitureMetalSlotMessage.class, FurnitureMetalSlotMessage::buffer, FurnitureMetalSlotMessage::new, FurnitureMetalSlotMessage::handler);
	}
}
