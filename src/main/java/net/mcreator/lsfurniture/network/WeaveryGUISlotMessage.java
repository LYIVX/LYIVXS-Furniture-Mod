...
public class WeaveryGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public WeaveryGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public WeaveryGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(WeaveryGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(WeaveryGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(WeaveryGUISlotMessage.class, WeaveryGUISlotMessage::buffer, WeaveryGUISlotMessage::new, WeaveryGUISlotMessage::handler);
	}
}
