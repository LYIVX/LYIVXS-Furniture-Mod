...
public class MetalGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public MetalGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public MetalGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(MetalGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MetalGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = MetalGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(MetalGUISlotMessage.class, MetalGUISlotMessage::buffer, MetalGUISlotMessage::new, MetalGUISlotMessage::handler);
	}
}
