...
public class FurnitureDecorationsSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public FurnitureDecorationsSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public FurnitureDecorationsSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(FurnitureDecorationsSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(FurnitureDecorationsSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(FurnitureDecorationsSlotMessage.class, FurnitureDecorationsSlotMessage::buffer, FurnitureDecorationsSlotMessage::new, FurnitureDecorationsSlotMessage::handler);
	}
}
