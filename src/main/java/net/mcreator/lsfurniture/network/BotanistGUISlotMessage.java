...
public class BotanistGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public BotanistGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public BotanistGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(BotanistGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BotanistGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(BotanistGUISlotMessage.class, BotanistGUISlotMessage::buffer, BotanistGUISlotMessage::new, BotanistGUISlotMessage::handler);
	}
}
