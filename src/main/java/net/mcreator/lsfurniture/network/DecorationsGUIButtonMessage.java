...
public class DecorationsGUIButtonMessage {
	private final int buttonID, x, y, z;

	public DecorationsGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public DecorationsGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(DecorationsGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(DecorationsGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(DecorationsGUIButtonMessage.class, DecorationsGUIButtonMessage::buffer, DecorationsGUIButtonMessage::new, DecorationsGUIButtonMessage::handler);
	}
}
