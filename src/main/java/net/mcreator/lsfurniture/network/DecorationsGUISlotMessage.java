...
public class DecorationsGUISlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public DecorationsGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public DecorationsGUISlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(DecorationsGUISlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(DecorationsGUISlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = DecorationsGUIMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(DecorationsGUISlotMessage.class, DecorationsGUISlotMessage::buffer, DecorationsGUISlotMessage::new, DecorationsGUISlotMessage::handler);
	}
}
