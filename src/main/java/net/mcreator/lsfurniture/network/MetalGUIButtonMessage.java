...
public class MetalGUIButtonMessage {
	private final int buttonID, x, y, z;

	public MetalGUIButtonMessage(FriendlyByteBuf buffer) {
	...
	public MetalGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(MetalGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(MetalGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		LsFurnitureMod.addNetworkMessage(MetalGUIButtonMessage.class, MetalGUIButtonMessage::buffer, MetalGUIButtonMessage::new, MetalGUIButtonMessage::handler);
	}
}
