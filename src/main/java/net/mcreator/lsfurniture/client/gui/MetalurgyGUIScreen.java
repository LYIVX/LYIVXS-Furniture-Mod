...
import net.mcreator.lsfurniture.network.MetalurgyGUIButtonMessage;
...
public class MetalurgyGUIScreen extends AbstractContainerScreen<MetalurgyGUIMenu> {
	private final static HashMap<String, Object> guistate = MetalurgyGUIMenu.guistate;
	...
	public MetalurgyGUIScreen(MetalurgyGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("ls_furniture:textures/screens/metalurgy_gui.png");
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 3 && mouseX < leftPos + 27 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.metalurgy_gui.tooltip_carpentry"), mouseX, mouseY);
		if (mouseX > leftPos + 42 && mouseX < leftPos + 66 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.metalurgy_gui.tooltip_masonry"), mouseX, mouseY);
		if (mouseX > leftPos + 81 && mouseX < leftPos + 105 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.metalurgy_gui.tooltip_metalurgy"), mouseX, mouseY);
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.ls_furniture.metalurgy_gui.label_carpentry"), 5, -2, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_tab_deselect_left_edge = new ImageButton(this.leftPos + 0, this.topPos + -35, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_left_edge.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(0, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect1 = new ImageButton(this.leftPos + 117, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect1.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(1, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_right_edge_2 = new ImageButton(this.leftPos + 156, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_right_edge_2.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(2, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_right_edge_3 = new ImageButton(this.leftPos + 39, this.topPos + -35, 32, 35, 0, 0, 35, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_right_edge_3.png"), 32, 70, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(3, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_oak_wood = new ImageButton(this.leftPos + 4, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_oak_wood.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(4, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		guistate.put("button:imagebutton_oak_wood", imagebutton_oak_wood);
		this.addRenderableWidget(imagebutton_oak_wood);
		imagebutton_tab_select = new ImageButton(this.leftPos + 78, this.topPos + -31, 32, 34, 0, 0, 34, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_select.png"), 32, 68, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(5, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_stone = new ImageButton(this.leftPos + 43, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_stone.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(6, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_iron_ingot = new ImageButton(this.leftPos + 82, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_iron_ingot.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(7, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_wool = new ImageButton(this.leftPos + 121, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_wool.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new MetalurgyGUIButtonMessage(8, x, y, z));
				MetalurgyGUIButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
