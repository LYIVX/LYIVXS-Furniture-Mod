...
import net.mcreator.lsfurniture.network.DecorationsGUIButtonMessage;
...
public class DecorationsGUIScreen extends AbstractContainerScreen<DecorationsGUIMenu> {
	private final static HashMap<String, Object> guistate = DecorationsGUIMenu.guistate;
	...
	public DecorationsGUIScreen(DecorationsGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("ls_furniture:textures/screens/decorations_gui.png");
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 3 && mouseX < leftPos + 27 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.decorations_gui.tooltip_wood"), mouseX, mouseY);
		if (mouseX > leftPos + 39 && mouseX < leftPos + 63 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.decorations_gui.tooltip_metal"), mouseX, mouseY);
		if (mouseX > leftPos + 75 && mouseX < leftPos + 99 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.decorations_gui.tooltip_decorations"), mouseX, mouseY);
		if (mouseX > leftPos + 111 && mouseX < leftPos + 135 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.decorations_gui.tooltip_teddys"), mouseX, mouseY);
		if (mouseX > leftPos + 147 && mouseX < leftPos + 171 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.decorations_gui.tooltip_chisel"), mouseX, mouseY);
	}
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.ls_furniture.decorations_gui.label_wood"), 5, -2, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_book_brown = new ImageButton(this.leftPos + 13, this.topPos + 55, 16, 16, 0, 0, 16, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_book_brown.png"), 16, 32, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(0, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_right_edge = new ImageButton(this.leftPos + 36, this.topPos + -35, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_right_edge.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(1, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_tab_select = new ImageButton(this.leftPos + 72, this.topPos + -31, 32, 34, 0, 0, 34, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_select.png"), 32, 68, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(2, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect1 = new ImageButton(this.leftPos + 108, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect1.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(3, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect2 = new ImageButton(this.leftPos + 144, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect2.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(4, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_oak_wood = new ImageButton(this.leftPos + 4, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_oak_wood.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(6, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_iron_ingot = new ImageButton(this.leftPos + 40, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_iron_ingot.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(7, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_computer = new ImageButton(this.leftPos + 76, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_computer.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(8, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_toddys = new ImageButton(this.leftPos + 112, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_toddys.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(9, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		...
		imagebutton_chisel = new ImageButton(this.leftPos + 148, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_chisel.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new DecorationsGUIButtonMessage(10, x, y, z));
				DecorationsGUIButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
