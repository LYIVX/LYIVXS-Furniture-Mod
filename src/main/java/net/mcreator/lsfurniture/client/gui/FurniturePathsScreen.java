...
import net.mcreator.lsfurniture.network.FurniturePathsButtonMessage;
...
public class FurniturePathsScreen extends AbstractContainerScreen<FurniturePathsMenu> {
	private final static HashMap<String, Object> guistate = FurniturePathsMenu.guistate;
	...
	public FurniturePathsScreen(FurniturePathsMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("ls_furniture:textures/screens/furniture_paths.png");
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 3 && mouseX < leftPos + 27 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_empty"), mouseX, mouseY);
		if (mouseX > leftPos + 36 && mouseX < leftPos + 60 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_empty1"), mouseX, mouseY);
		if (mouseX > leftPos + 69 && mouseX < leftPos + 93 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_empty2"), mouseX, mouseY);
		if (mouseX > leftPos + 102 && mouseX < leftPos + 126 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_empty3"), mouseX, mouseY);
		if (mouseX > leftPos + 18 && mouseX < leftPos + 42 && mouseY > topPos + 107 && mouseY < topPos + 131)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_recipe_explainer"), mouseX, mouseY);
		if (mouseX > leftPos + 135 && mouseX < leftPos + 159 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_paths"), mouseX, mouseY);
		if (mouseX > leftPos + 168 && mouseX < leftPos + 192 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_paths.tooltip_decorations"), mouseX, mouseY);
	}
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("ls_furniture:textures/screens/path.png"));
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.ls_furniture.furniture_paths.label_furniture"), 14, 6, -12829636);
		this.font.draw(poseStack, Component.translatable("gui.ls_furniture.furniture_paths.label_recipe"), 230, 6, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_tab_deselect1 = new ImageButton(this.leftPos + 32, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect1.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(0, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect2 = new ImageButton(this.leftPos + 65, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect2.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(1, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_left_edge = new ImageButton(this.leftPos + 0, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_left_edge.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(2, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_oak_wood = new ImageButton(this.leftPos + 4, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_oak_wood.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(3, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_stone = new ImageButton(this.leftPos + 37, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_stone.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(4, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_iron_ingot = new ImageButton(this.leftPos + 69, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_iron_ingot.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(5, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_question_mark = new ImageButton(this.leftPos + 22, this.topPos + 110, 16, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_question_mark.png"), 16, 36, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(6, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect = new ImageButton(this.leftPos + 98, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(7, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_toddys = new ImageButton(this.leftPos + 102, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_toddys.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(8, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_furniture_crafter_button_default = new ImageButton(this.leftPos + 61, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default.png"), 17, 36, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(9, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		...
		imagebutton_furniture_crafter_button_default1 = new ImageButton(this.leftPos + 78, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default1.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(10, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 10, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default2 = new ImageButton(this.leftPos + 95, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default2.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(11, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 11, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default3 = new ImageButton(this.leftPos + 112, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default3.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(12, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 12, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default4 = new ImageButton(this.leftPos + 129, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default4.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(13, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 13, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default5 = new ImageButton(this.leftPos + 146, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default5.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(14, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 14, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default6 = new ImageButton(this.leftPos + 163, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default6.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(15, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 15, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default7 = new ImageButton(this.leftPos + 180, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default7.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(16, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 16, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default8 = new ImageButton(this.leftPos + 197, this.topPos + 9, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default8.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(17, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 17, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default9 = new ImageButton(this.leftPos + 61, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default9.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(18, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 18, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default10 = new ImageButton(this.leftPos + 78, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default10.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(19, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 19, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default11 = new ImageButton(this.leftPos + 95, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default11.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(20, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 20, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default12 = new ImageButton(this.leftPos + 112, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default12.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(21, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 21, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default13 = new ImageButton(this.leftPos + 129, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default13.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(22, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 22, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default14 = new ImageButton(this.leftPos + 146, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default14.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(23, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 23, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default15 = new ImageButton(this.leftPos + 163, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default15.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(24, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 24, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default16 = new ImageButton(this.leftPos + 180, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default16.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(25, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 25, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default17 = new ImageButton(this.leftPos + 197, this.topPos + 27, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default17.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(26, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 26, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default18 = new ImageButton(this.leftPos + 61, this.topPos + 45, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default18.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(27, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 27, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default19 = new ImageButton(this.leftPos + 78, this.topPos + 45, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default19.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(28, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 28, x, y, z);
					}
				});
		...
		imagebutton_furniture_crafter_button_default20 = new ImageButton(this.leftPos + 95, this.topPos + 45, 17, 18, 0, 0, 18, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_furniture_crafter_button_default20.png"), 17, 36,
				e -> {
					if (true) {
						LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(29, x, y, z));
						FurniturePathsButtonMessage.handleButtonAction(entity, 29, x, y, z);
					}
				});
		...
		imagebutton_tab_deselect3 = new ImageButton(this.leftPos + 164, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect3.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(30, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 30, x, y, z);
			}
		});
		...
		imagebutton_computer = new ImageButton(this.leftPos + 168, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_computer.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurniturePathsButtonMessage(31, x, y, z));
				FurniturePathsButtonMessage.handleButtonAction(entity, 31, x, y, z);
			}
		});
