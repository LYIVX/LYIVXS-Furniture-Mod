...
public class FurnitureTeddysScreen extends AbstractContainerScreen<FurnitureTeddysMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 36 && mouseX < leftPos + 60 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_teddys.tooltip_empty1"), mouseX, mouseY);
		...
		if (mouseX > leftPos + 135 && mouseX < leftPos + 159 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.furniture_teddys.tooltip_paths"), mouseX, mouseY);
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 102, this.topPos + -25, 0, 0, 24, 24, 24, 24);
	...
	public void init() {
		...
		imagebutton_tab_deselect = new ImageButton(this.leftPos + 131, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurnitureTeddysButtonMessage(19, x, y, z));
				FurnitureTeddysButtonMessage.handleButtonAction(entity, 19, x, y, z);
			}
		});
		...
		imagebutton_path = new ImageButton(this.leftPos + 135, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_path.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurnitureTeddysButtonMessage(20, x, y, z));
				FurnitureTeddysButtonMessage.handleButtonAction(entity, 20, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect3 = new ImageButton(this.leftPos + 164, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect3.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurnitureTeddysButtonMessage(21, x, y, z));
				FurnitureTeddysButtonMessage.handleButtonAction(entity, 21, x, y, z);
			}
		});
		...
		imagebutton_computer = new ImageButton(this.leftPos + 168, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_computer.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new FurnitureTeddysButtonMessage(22, x, y, z));
				FurnitureTeddysButtonMessage.handleButtonAction(entity, 22, x, y, z);
			}
		});
