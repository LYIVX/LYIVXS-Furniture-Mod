...
public class CarpentryGUIScreen extends AbstractContainerScreen<CarpentryGUIMenu> {
	private final static HashMap<String, Object> guistate = CarpentryGUIMenu.guistate;
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 3 && mouseX < leftPos + 27 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.carpentry_gui.tooltip_carpentry"), mouseX, mouseY);
		if (mouseX > leftPos + 42 && mouseX < leftPos + 66 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.carpentry_gui.tooltip_masonry"), mouseX, mouseY);
		if (mouseX > leftPos + 81 && mouseX < leftPos + 105 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.carpentry_gui.tooltip_metalurgy"), mouseX, mouseY);
		if (mouseX > leftPos + 120 && mouseX < leftPos + 144 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.carpentry_gui.tooltip_weavery"), mouseX, mouseY);
		if (mouseX > leftPos + 159 && mouseX < leftPos + 183 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.carpentry_gui.tooltip_engineering"), mouseX, mouseY);
		if (mouseX > leftPos + -25 && mouseX < leftPos + -1 && mouseY > topPos + -2 && mouseY < topPos + 22)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.carpentry_gui.tooltip_connected_textures"), mouseX, mouseY);
	}
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.ls_furniture.carpentry_gui.label_carpentry"), 5, -2, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_tab_deselect = new ImageButton(this.leftPos + 78, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect.png"), 32, 64, e -> {
			if (true) {
				...
				CarpentryGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect1 = new ImageButton(this.leftPos + 117, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect1.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(1, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_tab_select_left_edge = new ImageButton(this.leftPos + 0, this.topPos + -37, 32, 35, 0, 0, 35, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_select_left_edge.png"), 32, 70, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(2, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_right_edge_2 = new ImageButton(this.leftPos + 156, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_right_edge_2.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(3, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_right_edge_3 = new ImageButton(this.leftPos + 39, this.topPos + -35, 32, 35, 0, 0, 35, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_right_edge_3.png"), 32, 70, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(4, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_oak_wood = new ImageButton(this.leftPos + 4, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_oak_wood.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(5, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_stone = new ImageButton(this.leftPos + 43, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_stone.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(6, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_iron_ingot = new ImageButton(this.leftPos + 82, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_iron_ingot.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(7, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_wool = new ImageButton(this.leftPos + 121, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_wool.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(8, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_book_brown = new ImageButton(this.leftPos + 8, this.topPos + 48, 16, 16, 0, 0, 16, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_book_brown.png"), 16, 32, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(10, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
		...
		imagebutton_arrow_left = new ImageButton(this.leftPos + -15, this.topPos + -28, 11, 17, 0, 0, 17, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_arrow_left.png"), 11, 34, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new CarpentryGUIButtonMessage(11, x, y, z));
				CarpentryGUIButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		Connected = new Checkbox(this.leftPos + -23, this.topPos + 0, 20, 20, Component.translatable("gui.ls_furniture.carpentry_gui.Connected"),
