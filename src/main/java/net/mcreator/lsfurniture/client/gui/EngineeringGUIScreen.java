...
import net.mcreator.lsfurniture.network.EngineeringGUIButtonMessage;
...
public class EngineeringGUIScreen extends AbstractContainerScreen<EngineeringGUIMenu> {
	private final static HashMap<String, Object> guistate = EngineeringGUIMenu.guistate;
	...
	ImageButton imagebutton_tab_select_right_edge;
	ImageButton imagebutton_arrow_left;
	ImageButton imagebutton_arrow_right;
	ImageButton imagebutton_comparitor;

	public EngineeringGUIScreen(EngineeringGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("ls_furniture:textures/screens/engineering_gui.png");
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > leftPos + 3 && mouseX < leftPos + 27 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.engineering_gui.tooltip_carpentry"), mouseX, mouseY);
		if (mouseX > leftPos + 42 && mouseX < leftPos + 66 && mouseY > topPos + -31 && mouseY < topPos + -7)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.engineering_gui.tooltip_masonry"), mouseX, mouseY);
		if (mouseX > leftPos + 81 && mouseX < leftPos + 105 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.engineering_gui.tooltip_metalurgy"), mouseX, mouseY);
		if (mouseX > leftPos + 120 && mouseX < leftPos + 144 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.engineering_gui.tooltip_weavery"), mouseX, mouseY);
		if (mouseX > leftPos + 159 && mouseX < leftPos + 183 && mouseY > topPos + -25 && mouseY < topPos + -1)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.engineering_gui.tooltip_engineering"), mouseX, mouseY);
		if (mouseX > leftPos + -25 && mouseX < leftPos + -1 && mouseY > topPos + -2 && mouseY < topPos + 22)
			this.renderTooltip(ms, Component.translatable("gui.ls_furniture.engineering_gui.tooltip_connected_textures"), mouseX, mouseY);
	}
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		if (DisablePictureToolProcedure.execute(world, x, y, z)) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("ls_furniture:textures/screens/wrench.png"));
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.ls_furniture.engineering_gui.label_carpentry"), 5, -2, -12829636);
	}
	...
	public void init() {
		...
		imagebutton_tab_deselect_left_edge = new ImageButton(this.leftPos + 0, this.topPos + -35, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_left_edge.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(0, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect = new ImageButton(this.leftPos + 78, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(1, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 1, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect1 = new ImageButton(this.leftPos + 117, this.topPos + -29, 32, 32, 0, 0, 32, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect1.png"), 32, 64, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(2, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_tab_deselect_right_edge_3 = new ImageButton(this.leftPos + 39, this.topPos + -35, 32, 35, 0, 0, 35, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_deselect_right_edge_3.png"), 32, 70, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(3, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
		...
		imagebutton_oak_wood = new ImageButton(this.leftPos + 4, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_oak_wood.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(4, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 4, x, y, z);
			}
		});
		...
		imagebutton_stone = new ImageButton(this.leftPos + 43, this.topPos + -31, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_stone.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(5, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 5, x, y, z);
			}
		});
		...
		imagebutton_iron_ingot = new ImageButton(this.leftPos + 82, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_iron_ingot.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(6, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 6, x, y, z);
			}
		});
		...
		imagebutton_wool = new ImageButton(this.leftPos + 121, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_wool.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(7, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 7, x, y, z);
			}
		});
		...
		imagebutton_button = new ImageButton(this.leftPos + 6, this.topPos + 46, 20, 20, 0, 0, 20, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_button.png"), 20, 40, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(8, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 8, x, y, z);
			}
		});
		...
		imagebutton_book_brown = new ImageButton(this.leftPos + 8, this.topPos + 48, 16, 16, 0, 0, 16, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_book_brown.png"), 16, 32, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(9, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 9, x, y, z);
			}
		});
		guistate.put("button:imagebutton_book_brown", imagebutton_book_brown);
		this.addRenderableWidget(imagebutton_book_brown);
		imagebutton_tab_select_right_edge = new ImageButton(this.leftPos + 156, this.topPos + -31, 32, 35, 0, 0, 35, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_tab_select_right_edge.png"), 32, 70, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(10, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 10, x, y, z);
			}
		});
		guistate.put("button:imagebutton_tab_select_right_edge", imagebutton_tab_select_right_edge);
		this.addRenderableWidget(imagebutton_tab_select_right_edge);
		imagebutton_arrow_left = new ImageButton(this.leftPos + -15, this.topPos + -28, 11, 17, 0, 0, 17, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_arrow_left.png"), 11, 34, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(11, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 11, x, y, z);
			}
		});
		...
		imagebutton_arrow_right = new ImageButton(this.leftPos + 193, this.topPos + -22, 11, 17, 0, 0, 17, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_arrow_right.png"), 11, 34, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(12, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 12, x, y, z);
			}
		});
		...
		imagebutton_comparitor = new ImageButton(this.leftPos + 160, this.topPos + -25, 24, 24, 0, 0, 24, new ResourceLocation("ls_furniture:textures/screens/atlas/imagebutton_comparitor.png"), 24, 48, e -> {
			if (true) {
				LsFurnitureMod.PACKET_HANDLER.sendToServer(new EngineeringGUIButtonMessage(13, x, y, z));
				EngineeringGUIButtonMessage.handleButtonAction(entity, 13, x, y, z);
			}
		});
		guistate.put("button:imagebutton_comparitor", imagebutton_comparitor);
		this.addRenderableWidget(imagebutton_comparitor);
		Connected = new Checkbox(this.leftPos + -23, this.topPos + 0, 20, 20, Component.translatable("gui.ls_furniture.engineering_gui.Connected"),
