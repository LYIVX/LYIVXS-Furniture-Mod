...
import net.mcreator.lsfurniture.procedures.OnInitialEntitySpawnProcedure;
import net.mcreator.lsfurniture.init.LsFurnitureModEntities;

import javax.annotation.Nullable;

public class StoolEntity extends PathfinderMob {
	public StoolEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(LsFurnitureModEntities.STOOL.get(), world);
	}

	public StoolEntity(EntityType<StoolEntity> type, Level world) {
		super(type, world);
		maxUpStep = 1f;
		xpReward = 0;
		setNoAi(true);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		OnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
