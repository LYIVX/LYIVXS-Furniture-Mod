...
public class MasonryRecipeCategory implements IRecipeCategory<MasonryRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(LsFurnitureMod.MODID, "masonry");
    ...
    public MasonryRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<MasonryRecipe> getRecipeType() {
        return JeiPlugin.MASONRY_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, MasonryRecipe recipe, IFocusGroup focuses) {
