...
import net.mcreator.lsfurniture.block.TestBlock;
...
public class LsFurnitureModBlocks {
	...
	public static final RegistryObject<Block> OAK_IRON_TABLE_NONE = REGISTRY.register("oak_iron_table_none", () -> new OakIronTableNoneBlock());
	public static final RegistryObject<Block> OAK_GOLD_TABLE_NONE = REGISTRY.register("oak_gold_table_none", () -> new OakGoldTableNoneBlock());
	...
	public static final RegistryObject<Block> OAK_GOLD_TABLE_STRAIGHT = REGISTRY.register("oak_gold_table_straight", () -> new OakGoldTableStraightBlock());
	public static final RegistryObject<Block> OAK_GOLD_TABLE_CORNER = REGISTRY.register("oak_gold_table_corner", () -> new OakGoldTableCornerBlock());
	public static final RegistryObject<Block> OAK_GOLD_TABLE_JUNCTION = REGISTRY.register("oak_gold_table_junction", () -> new OakGoldTableJunctionBlock());
	public static final RegistryObject<Block> OAK_GOLD_TABLE_CROSS = REGISTRY.register("oak_gold_table_cross", () -> new OakGoldTableCrossBlock());
	public static final RegistryObject<Block> OAK_GOLD_TABLE_END = REGISTRY.register("oak_gold_table_end", () -> new OakGoldTableEndBlock());
	...
	public static final RegistryObject<Block> OAK_IRON_TABLE_CORNER = REGISTRY.register("oak_iron_table_corner", () -> new OakIronTableCornerBlock());
	public static final RegistryObject<Block> OAK_IRON_TABLE_JUNCTION = REGISTRY.register("oak_iron_table_junction", () -> new OakIronTableJunctionBlock());
	public static final RegistryObject<Block> OAK_IRON_TABLE_CROSS = REGISTRY.register("oak_iron_table_cross", () -> new OakIronTableCrossBlock());
	public static final RegistryObject<Block> OAK_IRON_TABLE_END = REGISTRY.register("oak_iron_table_end", () -> new OakIronTableEndBlock());
	public static final RegistryObject<Block> OAK_IRON_TABLE_STRAIGHT = REGISTRY.register("oak_iron_table_straight", () -> new OakIronTableStraightBlock());
