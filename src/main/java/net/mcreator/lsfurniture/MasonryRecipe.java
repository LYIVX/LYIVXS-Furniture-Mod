...
public class MasonryRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public MasonryRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Type implements RecipeType<MasonryRecipe> {
    ...
    public static class Serializer implements RecipeSerializer<MasonryRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(LsFurnitureMod.MODID, "masonry");

        @Override
        public MasonryRecipe fromJson(ResourceLocation p_44103_, JsonObject p_44104_) {
...
//pRecipeId = p_44104
            ...
            return new MasonryRecipe(p_44103_, output, inputs);
        }

        @Override
        public @Nullable MasonryRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
            ...
            return new MasonryRecipe(id, output, inputs);
        }

        @Override
        public void toNetwork(FriendlyByteBuf buf, MasonryRecipe recipe) {
