...
public class MetallurgyRecipeCategory implements IRecipeCategory<MetallurgyRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(LsFurnitureMod.MODID, "metallurgy");
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, MetallurgyRecipe recipe, IFocusGroup focuses) {
