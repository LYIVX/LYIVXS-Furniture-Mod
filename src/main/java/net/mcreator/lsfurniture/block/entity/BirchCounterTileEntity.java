...
public class BirchCounterTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BirchCounterTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BirchCounterTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
