...
public class SpruceAndesiteSinkTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SpruceAndesiteSinkTileEntity(BlockPos pos, BlockState state) {
		super(LsFurnitureModBlockEntities.SPRUCE_ANDESITE_SINK.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<SpruceAndesiteSinkTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<SpruceAndesiteSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("spruce_andesite_sink");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Sink (Spruce/Andesite)");
	}
