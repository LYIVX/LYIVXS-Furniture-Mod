...
public class CrimsonNetherWartSinkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CrimsonNetherWartSinkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CrimsonNetherWartSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
