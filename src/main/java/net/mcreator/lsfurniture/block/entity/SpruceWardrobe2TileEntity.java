...
public class SpruceWardrobe2TileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SpruceWardrobe2TileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SpruceWardrobe2TileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
