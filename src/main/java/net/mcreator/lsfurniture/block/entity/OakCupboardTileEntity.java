...
public class OakCupboardTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<OakCupboardTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<OakCupboardTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
