...
public class CrimsonNetherWartCounterTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CrimsonNetherWartCounterTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CrimsonNetherWartCounterTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
