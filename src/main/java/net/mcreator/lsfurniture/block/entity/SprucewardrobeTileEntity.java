...
public class SprucewardrobeTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SprucewardrobeTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SprucewardrobeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
