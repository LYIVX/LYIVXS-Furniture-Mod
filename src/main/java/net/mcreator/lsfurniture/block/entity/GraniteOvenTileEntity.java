...
public class GraniteOvenTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<GraniteOvenTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<GraniteOvenTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
