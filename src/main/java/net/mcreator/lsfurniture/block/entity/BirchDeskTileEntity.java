...
public class BirchDeskTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BirchDeskTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BirchDeskTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
