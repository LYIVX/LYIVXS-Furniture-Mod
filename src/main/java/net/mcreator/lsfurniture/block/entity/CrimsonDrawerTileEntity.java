...
public class CrimsonDrawerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CrimsonDrawerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CrimsonDrawerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
