...
public class OakDeskTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<OakDeskTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<OakDeskTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
