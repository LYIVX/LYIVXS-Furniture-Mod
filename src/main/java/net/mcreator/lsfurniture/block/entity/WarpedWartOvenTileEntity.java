...
public class WarpedWartOvenTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WarpedWartOvenTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WarpedWartOvenTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
