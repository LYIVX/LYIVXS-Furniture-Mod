...
public class FurnitureCrafterBetaTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public FurnitureCrafterBetaTileEntity(BlockPos pos, BlockState state) {
		super(LsFurnitureModBlockEntities.FURNITURE_CRAFTER_BETA.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<FurnitureCrafterBetaTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<FurnitureCrafterBetaTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("furniture_crafter_beta");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Furniture Crafter Beta");
	}
