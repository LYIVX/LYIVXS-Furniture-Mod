...
public class JungleWardrobeTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<JungleWardrobeTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<JungleWardrobeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
