...
public class KettleTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<KettleTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<KettleTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
