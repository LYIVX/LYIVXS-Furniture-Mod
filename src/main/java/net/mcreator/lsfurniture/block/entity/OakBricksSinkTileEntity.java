...
public class OakBricksSinkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<OakBricksSinkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<OakBricksSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
