...
public class SpruceDrawerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SpruceDrawerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SpruceDrawerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
