...
public class MangroveDrawerTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MangroveDrawerTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MangroveDrawerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
