...
public class MangroveCounterTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MangroveCounterTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MangroveCounterTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
