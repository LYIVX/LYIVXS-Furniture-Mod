...
public class CrimsonCupboardTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CrimsonCupboardTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CrimsonCupboardTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
