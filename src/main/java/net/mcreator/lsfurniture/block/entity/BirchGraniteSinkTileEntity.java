...
public class BirchGraniteSinkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BirchGraniteSinkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BirchGraniteSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
