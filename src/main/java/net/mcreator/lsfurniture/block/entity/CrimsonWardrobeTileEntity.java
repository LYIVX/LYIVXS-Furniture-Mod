...
public class CrimsonWardrobeTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<CrimsonWardrobeTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<CrimsonWardrobeTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
