...
public class MangroveQuartzSinkTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MangroveQuartzSinkTileEntity(BlockPos pos, BlockState state) {
		super(LsFurnitureModBlockEntities.MANGROVE_QUARTZ_SINK.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<MangroveQuartzSinkTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<MangroveQuartzSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("mangrove_quartz_sink");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Sink (Mangrove/Quartz)");
	}
