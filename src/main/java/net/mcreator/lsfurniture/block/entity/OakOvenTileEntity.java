...
public class OakOvenTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<OakOvenTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<OakOvenTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
