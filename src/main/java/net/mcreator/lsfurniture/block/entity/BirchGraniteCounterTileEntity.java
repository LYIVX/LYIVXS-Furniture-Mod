...
public class BirchGraniteCounterTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<BirchGraniteCounterTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<BirchGraniteCounterTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
