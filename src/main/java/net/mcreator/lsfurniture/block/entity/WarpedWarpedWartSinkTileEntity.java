...
public class WarpedWarpedWartSinkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WarpedWarpedWartSinkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WarpedWarpedWartSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
