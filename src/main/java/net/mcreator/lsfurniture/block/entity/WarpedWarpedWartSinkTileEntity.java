...
public class WarpedWarpedWartSinkTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WarpedWarpedWartSinkTileEntity(BlockPos pos, BlockState state) {
		super(LsFurnitureModBlockEntities.WARPED_WARPED_WART_SINK.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<WarpedWarpedWartSinkTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<WarpedWarpedWartSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("warped_warped_wart_sink");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Sink (Warped/Warped Wart)");
	}
