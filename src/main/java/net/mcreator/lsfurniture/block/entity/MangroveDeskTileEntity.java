...
public class MangroveDeskTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<MangroveDeskTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<MangroveDeskTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
