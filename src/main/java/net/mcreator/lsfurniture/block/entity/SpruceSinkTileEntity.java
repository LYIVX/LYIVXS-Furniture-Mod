...
public class SpruceSinkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SpruceSinkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SpruceSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
