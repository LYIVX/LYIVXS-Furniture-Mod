...
public class DeepslateOvenTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<DeepslateOvenTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<DeepslateOvenTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
