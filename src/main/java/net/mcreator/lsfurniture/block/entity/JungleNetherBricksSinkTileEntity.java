...
public class JungleNetherBricksSinkTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public JungleNetherBricksSinkTileEntity(BlockPos pos, BlockState state) {
		super(LsFurnitureModBlockEntities.JUNGLE_NETHER_BRICKS_SINK.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<JungleNetherBricksSinkTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<JungleNetherBricksSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("jungle_nether_bricks_sink");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Sink (Jungle/Nether Bricks)");
	}
	...
	private final FluidTank fluidTank = new FluidTank(1) {
		@Override
