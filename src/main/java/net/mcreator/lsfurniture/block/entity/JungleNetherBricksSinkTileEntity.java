...
public class JungleNetherBricksSinkTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<JungleNetherBricksSinkTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<JungleNetherBricksSinkTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
