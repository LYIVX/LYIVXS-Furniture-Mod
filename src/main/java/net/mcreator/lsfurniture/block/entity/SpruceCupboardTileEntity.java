...
public class SpruceCupboardTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SpruceCupboardTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SpruceCupboardTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
