...
public class FurnitureCrafterBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(33, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FurnitureCrafterBlockEntity(BlockPos position, BlockState state) {
		super(LsFurnitureModBlockEntities.FURNITURE_CRAFTER.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("furniture_crafter");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Furniture Crafter");
	}
