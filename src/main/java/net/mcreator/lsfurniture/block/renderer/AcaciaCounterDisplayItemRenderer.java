...
public class AcaciaCounterDisplayItemRenderer extends GeoItemRenderer<AcaciaCounterDisplayItem> {
	...
	@Override
	public RenderType getRenderType(AcaciaCounterDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
