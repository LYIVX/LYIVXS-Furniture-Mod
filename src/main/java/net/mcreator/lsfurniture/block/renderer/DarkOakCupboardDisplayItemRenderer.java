...
public class DarkOakCupboardDisplayItemRenderer extends GeoItemRenderer<DarkOakCupboardDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DarkOakCupboardDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
