...
public class JungleOvenDisplayItemRenderer extends GeoItemRenderer<JungleOvenDisplayItem> {
	...
	@Override
	public RenderType getRenderType(JungleOvenDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
