...
public class MangroveCupboardDisplayItemRenderer extends GeoItemRenderer<MangroveCupboardDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MangroveCupboardDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
