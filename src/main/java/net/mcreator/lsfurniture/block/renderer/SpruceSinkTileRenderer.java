...
public class SpruceSinkTileRenderer extends GeoBlockRenderer<SpruceSinkTileEntity> {
	public SpruceSinkTileRenderer() {
		super(new SpruceSinkBlockModel());
	}

	@Override
	public RenderType getRenderType(SpruceSinkTileEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
