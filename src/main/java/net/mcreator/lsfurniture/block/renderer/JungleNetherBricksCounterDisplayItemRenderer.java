...
public class JungleNetherBricksCounterDisplayItemRenderer extends GeoItemRenderer<JungleNetherBricksCounterDisplayItem> {
	...
	@Override
	public RenderType getRenderType(JungleNetherBricksCounterDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
