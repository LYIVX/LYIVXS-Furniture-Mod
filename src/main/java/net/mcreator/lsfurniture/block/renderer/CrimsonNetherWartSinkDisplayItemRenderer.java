...
public class CrimsonNetherWartSinkDisplayItemRenderer extends GeoItemRenderer<CrimsonNetherWartSinkDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CrimsonNetherWartSinkDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
