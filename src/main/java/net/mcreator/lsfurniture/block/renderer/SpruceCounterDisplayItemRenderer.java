...
public class SpruceCounterDisplayItemRenderer extends GeoItemRenderer<SpruceCounterDisplayItem> {
	...
	@Override
	public RenderType getRenderType(SpruceCounterDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
