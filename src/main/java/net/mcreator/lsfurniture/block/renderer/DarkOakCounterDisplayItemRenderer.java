...
public class DarkOakCounterDisplayItemRenderer extends GeoItemRenderer<DarkOakCounterDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DarkOakCounterDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
