...
public class WarpedWardrobe1DisplayItemRenderer extends GeoItemRenderer<WarpedWardrobe1DisplayItem> {
	...
	@Override
	public RenderType getRenderType(WarpedWardrobe1DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
