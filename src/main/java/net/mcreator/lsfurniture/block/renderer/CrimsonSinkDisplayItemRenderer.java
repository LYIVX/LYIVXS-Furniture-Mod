...
public class CrimsonSinkDisplayItemRenderer extends GeoItemRenderer<CrimsonSinkDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CrimsonSinkDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
