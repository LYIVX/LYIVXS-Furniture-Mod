...
public class WarpedWarpedWartCounterDisplayItemRenderer extends GeoItemRenderer<WarpedWarpedWartCounterDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WarpedWarpedWartCounterDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
