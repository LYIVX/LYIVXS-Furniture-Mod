...
public class OakCupboardDisplayItemRenderer extends GeoItemRenderer<OakCupboardDisplayItem> {
	...
	@Override
	public RenderType getRenderType(OakCupboardDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
