...
public class BirchDrawerDisplayItemRenderer extends GeoItemRenderer<BirchDrawerDisplayItem> {
	...
	@Override
	public RenderType getRenderType(BirchDrawerDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
