...
public class FridgeFreezerBlock2DisplayItemRenderer extends GeoItemRenderer<FridgeFreezerBlock2DisplayItem> {
	...
	@Override
	public RenderType getRenderType(FridgeFreezerBlock2DisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
