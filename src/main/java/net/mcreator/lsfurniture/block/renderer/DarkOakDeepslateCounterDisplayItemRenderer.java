...
public class DarkOakDeepslateCounterDisplayItemRenderer extends GeoItemRenderer<DarkOakDeepslateCounterDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DarkOakDeepslateCounterDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
