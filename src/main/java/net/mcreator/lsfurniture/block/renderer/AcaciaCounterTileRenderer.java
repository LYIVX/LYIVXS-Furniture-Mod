...
public class AcaciaCounterTileRenderer extends GeoBlockRenderer<AcaciaCounterTileEntity> {
	public AcaciaCounterTileRenderer() {
		super(new AcaciaCounterBlockModel());
	}

	@Override
	public RenderType getRenderType(AcaciaCounterTileEntity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
