...
public class OakBricksSinkDisplayItemRenderer extends GeoItemRenderer<OakBricksSinkDisplayItem> {
	...
	@Override
	public RenderType getRenderType(OakBricksSinkDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
