...
public class DarkOakOvenDisplayItemRenderer extends GeoItemRenderer<DarkOakOvenDisplayItem> {
	...
	@Override
	public RenderType getRenderType(DarkOakOvenDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
