...
public class MangroveOvenDisplayItemRenderer extends GeoItemRenderer<MangroveOvenDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MangroveOvenDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
