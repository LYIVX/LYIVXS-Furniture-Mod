...
public class MangroveWardrobeDisplayItemRenderer extends GeoItemRenderer<MangroveWardrobeDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MangroveWardrobeDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
