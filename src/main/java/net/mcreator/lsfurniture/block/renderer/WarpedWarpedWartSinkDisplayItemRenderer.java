...
public class WarpedWarpedWartSinkDisplayItemRenderer extends GeoItemRenderer<WarpedWarpedWartSinkDisplayItem> {
	...
	@Override
	public RenderType getRenderType(WarpedWarpedWartSinkDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
