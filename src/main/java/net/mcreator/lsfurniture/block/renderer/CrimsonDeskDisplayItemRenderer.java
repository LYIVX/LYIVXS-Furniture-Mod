...
public class CrimsonDeskDisplayItemRenderer extends GeoItemRenderer<CrimsonDeskDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CrimsonDeskDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
