...
import net.mcreator.lsfurniture.block.renderer.JungleCounterDisplayItemRenderer;
...
public class JungleCounterDisplayItem extends BlockItem implements IAnimatable {
	...
	public void initializeClient(Consumer<IClientItemExtensions> consumer) {
		...
		consumer.accept(new IClientItemExtensions() {
			private final BlockEntityWithoutLevelRenderer renderer = new JungleCounterDisplayItemRenderer();
