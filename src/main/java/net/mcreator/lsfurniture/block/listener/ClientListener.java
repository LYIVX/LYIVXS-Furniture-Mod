...
public class ClientListener {
	...
	public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.DEEPSLATE_OVEN.get(), DeepslateOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.ANDESITE_OVEN.get(), AndesiteOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.DIORITE_OVEN.get(), DioriteOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.GRANITE_OVEN.get(), GraniteOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.NETHER_BRICKS_OVEN.get(), NetherBricksOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.QUARTZ_OVEN.get(), QuartzOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.NETHER_WART_OVEN.get(), NetherWartOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.WARPED_WART_OVEN.get(), WarpedWartOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.BRICKS_OVEN.get(), BricksOvenTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.OAK_BRICKS_COUNTER.get(), OakBricksCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.DARK_OAK_DEEPSLATE_COUNTER.get(), DarkOakDeepslateCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.SPRUCE_ANDESITE_COUNTER.get(), SpruceAndesiteCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.BIRCH_GRANITE_COUNTER.get(), BirchGraniteCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.JUNGLE_NETHER_BRICKS_COUNTER.get(), JungleNetherBricksCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.MANGROVE_QUARTZ_COUNTER.get(), MangroveQuartzCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.CRIMSON_NETHER_WART_COUNTER.get(), CrimsonNetherWartCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.WARPED_WARPED_WART_COUNTER.get(), WarpedWarpedWartCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.OAK_BRICKS_SINK.get(), OakBricksSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.DARK_OAK_DEEPSLATE_SINK.get(), DarkOakDeepslateSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.SPRUCE_ANDESITE_SINK.get(), SpruceAndesiteSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.ACACIA_DIORITE_SINK.get(), AcaciaDioriteSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.BIRCH_GRANITE_SINK.get(), BirchGraniteSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.JUNGLE_NETHER_BRICKS_SINK.get(), JungleNetherBricksSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.MANGROVE_QUARTZ_SINK.get(), MangroveQuartzSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.CRIMSON_NETHER_WART_SINK.get(), CrimsonNetherWartSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.WARPED_WARPED_WART_SINK.get(), WarpedWarpedWartSinkTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.ACACIA_DIORITE_COUNTER.get(), AcaciaDioriteCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.ACACIA_COUNTER.get(), AcaciaCounterTileRenderer::new);
		event.registerBlockEntityRenderer(LsFurnitureModBlockEntities.DARK_OAK_DESK.get(), DarkOakDeskTileRenderer::new);
	}
}
