...
public class StoolBlockDestroyedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (!world.getEntitiesOfClass(StoolEntity.class, AABB.ofSize(new Vec3((x + 0.5), (y + 0.6), (z + 0.5)), 0.1, 0.1, 0.1), e -> true).isEmpty()) {
			{
				final Vec3 _center = new Vec3((x + 0.5), (y + 0.6), (z + 0.5));
