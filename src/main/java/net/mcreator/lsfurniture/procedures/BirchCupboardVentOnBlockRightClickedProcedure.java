...
public class BirchCupboardVentOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == LsFurnitureModBlocks.BIRCH_CUPBOARD_VENT.get()) {
			{
		...
		} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == LsFurnitureModBlocks.BIRCH_CUPBOARD_VENT_ON.get()) {
			{
				BlockPos _bp = new BlockPos(x, y, z);
