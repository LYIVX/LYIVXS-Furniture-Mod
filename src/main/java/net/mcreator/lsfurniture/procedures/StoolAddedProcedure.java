...
public class StoolAddedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if (world instanceof ServerLevel _level) {
			Entity entityToSpawn = new StoolEntity(LsFurnitureModEntities.STOOL.get(), _level);
			entityToSpawn.moveTo((x + 0.5), (y + 0.62), (z + 0.5), (float) direction, 0);
