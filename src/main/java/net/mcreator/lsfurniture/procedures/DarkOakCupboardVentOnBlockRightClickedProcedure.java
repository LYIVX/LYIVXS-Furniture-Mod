...
public class DarkOakCupboardVentOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == LsFurnitureModBlocks.DARK_OAK_CUPBOARD_VENT.get()) {
			{
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == LsFurnitureModBlocks.DARK_OAK_CUPBOARD_VENT_ON.get()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
