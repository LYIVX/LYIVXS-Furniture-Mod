...
public class CarpentryTickRecipeCategory implements IRecipeCategory<CarpentryTickRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(LsFurnitureMod.MODID, "carpentry_tick");
    ...
    public CarpentryTickRecipeCategory(IGuiHelper helper) {
    ...
    @Override
    public RecipeType<CarpentryTickRecipe> getRecipeType() {
        return JeiPlugin.CARPENTRY_TICK_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, CarpentryTickRecipe recipe, IFocusGroup focuses) {
